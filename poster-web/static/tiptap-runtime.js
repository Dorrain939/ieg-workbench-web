...
var Wr = typeof navigator < "u" ? navigator : null, Gr = typeof document < "u" ? document : null, Kr = Wr && Wr.userAgent || "", qr = /Edge\/(\d+)/.exec(Kr), Jr = /MSIE \d/.exec(Kr), Yr = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Kr), A = !!(Jr || Yr || qr), Xr = Jr ? document.documentMode : Yr ? +Yr[1] : qr ? +qr[1] : 0, Zr = !A && /gecko\/(\d+)/i.test(Kr);
Zr && +(/Firefox\/(\d+)/.exec(Kr) || [0, 0])[1];
var Qr = !A && /Chrome\/(\d+)/.exec(Kr), j = !!Qr, $r = Qr ? +Qr[1] : 0, M = !A && !!Wr && /Apple Computer/.test(Wr.vendor), ei = M && (/Mobile\/\w+/.test(Kr) || !!Wr && Wr.maxTouchPoints > 2), ti = ei || (Wr ? /Mac/.test(Wr.platform) : !1), ni = Wr ? /Win/.test(Wr.platform) : !1, ri = /Android \d/.test(Kr), ii = !!Gr && "webkitFontSmoothing" in Gr.documentElement.style, ai = ii ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function oi(e) {
...
function li(e, t, n) {
	...
	for (let o = n || e.dom; o;) {
		...
		let e = o, n = e == a.body, s = n ? oi(a) : ci(e), c = 0, l = 0;
		if (t.top < s.top + si(r, "top") ? l = -(s.top - t.top + si(i, "top")) : t.bottom > s.bottom - si(r, "bottom") && (l = t.bottom - t.top > s.bottom - s.top ? t.top + si(i, "top") - s.top : t.bottom - s.bottom + si(i, "bottom")), t.left < s.left + si(r, "left") ? c = -(s.left - t.left + si(i, "left")) : t.right > s.right - si(r, "right") && (c = t.right - s.right + si(i, "right")), c || l) if (n) a.defaultView.scrollBy(c, l);
		else {
...
function fi({ refDOM: e, refTop: t, stack: n }) {
...
function gi(e, t) {
	...
	return !n && c && (n = c, i = l, r = 0), n && n.nodeType == 3 ? _i(n, i) : !n || r && n.nodeType == 1 ? {
		node: e,
		offset: a
	} : gi(n, i);
}
...
function bi(e, t, n) {
	let { node: r, offset: i } = gi(t, n), a = -1;
...
function Ci(e, t) {
	...
	if (!o || !e.dom.contains(o.nodeType == 1 ? o : o.parentNode)) {
		...
		if (!vi(t, n) || (o = Si(e.dom, t, n), !o)) return null;
	}
	if (M) for (let e = o; r && e; e = Or(e)) e.draggable && (r = void 0);
	if (o = yi(o, t), r) {
		...
		let n;
		ii && i && r.nodeType == 1 && (n = r.childNodes[i - 1]).nodeType == 1 && n.contentEditable == "false" && n.getBoundingClientRect().top >= t.top && i--, r == e.dom && i == r.childNodes.length - 1 && r.lastChild.nodeType == 1 && t.top > r.lastChild.getBoundingClientRect().bottom ? s = e.state.doc.content.size : (i == 0 || r.nodeType != 1 || r.childNodes[i - 1].nodeName != "BR") && (s = xi(e, r, i, t));
	}
	s ??= bi(e, o, t);
...
function Ti(e, t) {
	...
	return Array.prototype.find.call(n, wi) || e.getBoundingClientRect();
}
var Ei = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/;
function Di(e, t, n) {
	let { node: r, offset: i, atom: a } = e.docView.domFromPos(t, n < 0 ? -1 : 1), o = ii || Zr;
	if (r.nodeType == 3) if (o && (Ei.test(r.nodeValue) || (n < 0 ? !i : i == r.nodeValue.length))) {
		let e = Ti(Ar(r, i, i), n);
		if (Zr && i && /\s/.test(r.nodeValue[i - 1]) && i < r.nodeValue.length) {
			let t = Ti(Ar(r, i - 1, i - 1), -1);
			if (t.top == e.top) {
				let n = Ti(Ar(r, i, i + 1), -1);
				if (n.top != e.top) return Oi(n, n.left < t.left);
			}
		}
		return e;
	} else {
		let e = i, t = i, a = n < 0 ? 1 : -1;
		return n < 0 && !i ? (t++, a = -1) : n >= 0 && i == r.nodeValue.length ? (e--, a = 1) : n < 0 ? e-- : t++, Oi(Ti(Ar(r, e, t), a), a < 0);
	}
	if (!e.state.doc.resolve(t - (a || 0)).parent.inlineContent) {
		if (a == null && i && (n < 0 || i == Fr(r))) {
			let e = r.childNodes[i - 1];
			if (e.nodeType == 1) return ki(e.getBoundingClientRect(), !1);
		}
		if (a == null && i < Fr(r)) {
			let e = r.childNodes[i];
			if (e.nodeType == 1) return ki(e.getBoundingClientRect(), !0);
		}
		return ki(r.getBoundingClientRect(), n >= 0);
	}
	if (a == null && i && (n < 0 || i == Fr(r))) {
		let e = r.childNodes[i - 1], t = e.nodeType == 3 ? Ar(e, Fr(e) - +!o) : e.nodeType == 1 && (e.nodeName != "BR" || !e.nextSibling) ? e : null;
		if (t) return Oi(Ti(t, 1), !1);
	}
	if (a == null && i < Fr(r)) {
		let e = r.childNodes[i];
		for (; e.pmViewDesc && e.pmViewDesc.ignoreForCoords;) e = e.nextSibling;
		let t = e ? e.nodeType == 3 ? Ar(e, 0, +!o) : e.nodeType == 1 ? e : null : null;
		if (t) return Oi(Ti(t, -1), !0);
	}
	return Oi(Ti(r.nodeType == 3 ? Ar(r) : r, -n), n >= 0);
}
function Oi(e, t) {
...
function Ni(e, t, n) {
	...
	return s ? !Mi.test(r.parent.textContent) || !s.modify ? n == "left" || n == "backward" ? a : o : Ai(e, t, () => {
...
var Pi = null, Fi = null, Ii = !1;
function Li(e, t, n) {
	return Pi == t && Fi == n ? Ii : (Pi = t, Fi = n, Ii = n == "up" || n == "down" ? ji(e, t, n) : Ni(e, t, n));
}
var Ri = 0, zi = 1, Bi = 2, Vi = 3, Hi = class {
	constructor(e, t, n, r) {
	...
	domFromPos(e, t) {
		...
		for (let e; n && !(e = this.children[n - 1]).size && e instanceof Ui && e.side >= 0; n--);
		if (t <= 0) {
			let e, r = !0;
	...
	setSelection(e, t, n, r = !1) {
		...
		if (Zr && l.focusNode && l.focusNode != s.node && l.focusNode.nodeType == 1) {
			let e = l.focusNode.childNodes[l.focusOffset];
			e && e.contentEditable == "false" && (r = !0);
		}
		if (!(r || u && M) && Mr(o.node, o.offset, l.anchorNode, l.anchorOffset) && Mr(s.node, s.offset, l.focusNode, l.focusOffset)) return;
		let d = !1;
		if ((c.extend || e == t) && !(u && Zr)) {
	...
	markDirty(e, t) {
		for (let n = 0, r = 0; r < this.children.length; r++) {
			...
			if (n == a ? e <= a && t >= n : e < a && t > n) {
				...
				if (e >= r && t <= o) {
					this.dirty = e == n || t == a ? Bi : zi, e == r && t == o && (i.contentLost || i.dom.parentNode != this.contentDOM) ? i.dirty = Vi : i.markDirty(e - r, t - r);
					return;
				} else i.dirty = i.dom == i.contentDOM && i.dom.parentNode == this.contentDOM && !i.children.length ? Bi : Vi;
			}
			n = a;
		}
		this.dirty = Bi;
	...
	parseRule() {
		return this.dirty & Vi || this.mark.type.spec.reparseInView ? null : {
	...
	matchesMark(e) {
		return this.dirty != Vi && this.mark.eq(e);
	}
	markDirty(e, t) {
	...
	slice(t, n, r) {
		...
		n < o && (a = fa(a, n, o, r)), t > 0 && (a = fa(a, 0, t, r));
	...
	static create(t, n, r, i, a, o) {
		...
		let f = u;
		return u = ra(u, r, n), l ? c = new Xi(t, n, r, i, u, d || null, f, l, a, o + 1) : n.isText ? new Ji(t, n, r, i, u, f, a) : new e(t, n, r, i, u, d || null, f, a, o + 1);
	}
	parseRule() {
	...
	matchesNode(e, t, n) {
		return this.dirty == Ri && e.eq(this.node) && ia(t, this.outerDeco) && n.eq(this.innerDeco);
	}
	get size() {
	...
	updateChildren(e, t) {
		let n = this.node.inlineContent, r = t, i = e.composing ? this.localCompositionInfo(e, t) : null, a = i && i.pos > -1 ? i : null, o = i && i.pos < 0, s = new oa(this, a && a.node, e);
		la(this.node, this.innerDeco, (t, i, a) => {
		...
		}), s.syncToMarks([], n, e, 0), this.node.isTextblock && s.addTextblockHacks(), s.destroyRest(), (s.changed || this.dirty == Bi) && (a && this.protectLocalComposition(e, a), Zi(this.contentDOM, this.children, e), ei && ua(this.dom));
	}
	localCompositionInfo(e, t) {
		...
		if (this.node.inlineContent) {
			let e = i.nodeValue, a = da(this.node.content, e, n - t, r - t);
			return a < 0 ? null : {
				node: i,
				pos: a,
				text: e
	...
	protectLocalComposition(e, { node: t, pos: n, text: r }) {
		...
		let a = new Wi(this, i, t, r);
		e.input.compositionNodes.push(a), this.children = fa(this.children, n, n + r.length, e, a);
	}
	update(e, t, n, r) {
		return this.dirty == Vi || !e.sameMarkup(this.node) ? !1 : (this.updateInner(e, t, n, r), !0);
	}
	updateInner(e, t, n, r) {
		this.updateOuterDeco(t), this.node = e, this.innerDeco = n, this.contentDOM && this.updateChildren(r, this.posAtStart), this.dirty = Ri;
	}
	updateOuterDeco(e) {
		if (ia(e, this.outerDeco)) return;
		let t = this.nodeDOM.nodeType != 1, n = this.dom;
		this.dom = ta(this.dom, this.nodeDOM, ea(this.outerDeco, this.node, t), ea(e, this.node, t)), this.dom != n && (n.pmViewDesc = void 0, this.dom.pmViewDesc = this), this.outerDeco = e;
	}
	selectNode() {
...
var Ji = class e extends Ki {
	...
	update(e, t, n, r) {
		return this.dirty == Vi || this.dirty != Ri && !this.inParent() || !e.sameMarkup(this.node) ? !1 : (this.updateOuterDeco(t), (this.dirty != Ri || e.text != this.node.text) && e.text != this.nodeDOM.nodeValue && (this.nodeDOM.nodeValue = e.text, r.trackWrites == this.nodeDOM && (r.trackWrites = null)), this.node = e, this.dirty = Ri, !0);
	}
	inParent() {
	...
	markDirty(e, t) {
		super.markDirty(e, t), this.dom != this.nodeDOM && (e == 0 || t == this.nodeDOM.nodeValue.length) && (this.dirty = Vi);
	}
	get domAtom() {
		return !1;
	}
...
Qi.prototype = Object.create(null);
var $i = [new Qi()];
function ea(e, t, n) {
	if (e.length == 0) return $i;
	let r = n ? $i[0] : new Qi(), i = [r];
	for (let a = 0; a < e.length; a++) {
		let o = e[a].type.attrs;
		if (o) {
			o.nodeName && i.push(r = new Qi(o.nodeName));
			for (let e in o) {
				let a = o[e];
				a != null && (n && i.length == 1 && i.push(r = new Qi(t.isInline ? "span" : "div")), e == "class" ? r.class = (r.class ? r.class + " " : "") + a : e == "style" ? r.style = (r.style ? r.style + ";" : "") + a : e != "nodeName" && (r[e] = a));
			}
		}
	}
	return i;
...
function ta(e, t, n, r) {
	...
	for (let t = 0; t < r.length; t++) {
		...
		if (t) {
			let t;
			o && o.nodeName == a.nodeName && i != e && (t = i.parentNode) && t.nodeName.toLowerCase() == a.nodeName ? i = t : (t = document.createElement(a.nodeName), t.pmIsDeco = !0, t.appendChild(i), o = $i[0], i = t);
		}
		na(i, o || $i[0], a);
	}
	return i;
...
function ra(e, t, n) {
	return ta(e, e, $i, ea(t, n, e.nodeType != 1));
}
function ia(e, t) {
	if (e.length != t.length) return !1;
...
var oa = class {
	constructor(e, t, n) {
		this.lock = t, this.view = n, this.index = 0, this.stack = [], this.changed = !1, this.top = e, this.preMatch = sa(e.node.content, e);
	}
	destroyBetween(e, t) {
		if (e != t) {
	...
	syncToMarks(e, t, n, r) {
		...
		for (; a < e.length;) {
			...
			if (i > -1) i > this.index && (this.changed = !0, this.destroyBetween(this.index, i)), this.top = this.top.children[this.index];
				...
				let r = Gi.create(this.top, e[a], t, n);
	...
	updateNodeAt(e, t, n, r, i) {
		let a = this.top.children[r];
		return a.dirty == Vi && a.dom == a.contentDOM && (a.dirty = Bi), a.update(e, t, n, i) ? (this.destroyBetween(this.index, r), this.index++, !0) : !1;
	}
	...
	updateNextNode(e, t, n, r, i, a) {
		for (let o = this.index; o < this.top.children.length; o++) {
			...
			if (s instanceof Ki) {
				...
				let l = s.dom, u, d = this.isLocked(l) && !(e.isText && s.node && s.node.isText && s.nodeDOM.nodeValue == e.text && s.dirty != Vi && ia(t, s.outerDeco));
				if (!d && s.update(e, t, n, r)) return this.destroyBetween(this.index, o), s.dom != l && (this.changed = !0), this.index++, !0;
				if (!d && (u = this.recreateWrapper(s, e, t, n, r, a))) return this.destroyBetween(this.index, o), this.top.children[this.index] = u, u.contentDOM && (u.dirty = Bi, u.updateChildren(r, a + 1), u.dirty = Ri), this.changed = !0, this.index++, !0;
				break;
			}
		}
		return !1;
	...
	recreateWrapper(e, t, n, r, i, a) {
		if (e.dirty || t.isAtom || !e.children.length || !e.node.content.eq(t.content) || !ia(n, e.outerDeco) || !r.eq(e.innerDeco)) return null;
	...
	placeWidget(e, t, n) {
		...
		if (r && r.matchesWidget(e) && (e == r.widget || !r.widget.type.toDOM.parentNode)) this.index++;
			...
			let r = new Ui(this.top, e, t, n);
			this.top.children.splice(this.index++, 0, r), this.changed = !0;
		}
	}
	addTextblockHacks() {
		let e = this.top.children[this.index - 1], t = this.top;
		for (; e instanceof Gi;) t = e, e = t.children[t.children.length - 1];
...
function sa(e, t) {
	...
	outer: for (; i > 0;) {
		...
		for (;;) if (r) {
			...
			if (e instanceof Gi) n = e, r = e.children.length;
			else {
				s = e, r--;
				break;
			}
...
function ma(e) {
	return e.editable ? e.hasFocus() : Ea(e) && document.activeElement && document.activeElement.contains(e.dom);
}
function ha(e, t = !1) {
	let n = e.state.selection;
	if (Sa(e, n), !ma(e)) return;
	...
	if (e.domObserver.disconnectSelection(), e.cursorWrapper) xa(e);
	else {
		let { anchor: r, head: i } = n, a, o;
		ga && !(n instanceof T) && (n.$from.parent.inlineContent || (a = _a(e, n.from)), !n.empty && !n.$from.parent.inlineContent && (o = _a(e, n.to))), e.docView.setSelection(r, i, e, t), ga && (a && ya(a), o && ya(o)), n.visible ? e.dom.classList.remove("ProseMirror-hideselection") : (e.dom.classList.add("ProseMirror-hideselection"), "onselectionchange" in document && ba(e));
	}
...
function _a(e, t) {
	...
	if (M && i && i.contentEditable == "false") return va(i);
...
function xa(e) {
	...
	r ? t.collapse(n.parentNode, k(n) + 1) : t.collapse(n, 0), !r && !e.state.selection.visible && A && Xr <= 11 && (n.disabled = !0, n.disabled = !1);
}
function Sa(e, t) {
	if (t instanceof E) {
		let n = e.docView.descAt(t.from);
		n != e.lastSelectedViewDesc && (Ca(e), n && n.selectNode(), e.lastSelectedViewDesc = n);
	} else Ca(e);
}
function Ca(e) {
...
function Ta(e) {
	return e.editable && !e.hasFocus() ? !1 : Ea(e);
}
function Ea(e) {
...
function Aa(e, t, n) {
	...
	if (r instanceof T) {
		if (n.indexOf("s") > -1) {
			...
			return i.isAtom || (a = e.docView.descAt(o)) && !a.contentDOM ? E.isSelectable(i) ? ka(e, new E(t < 0 ? e.state.doc.resolve(n.pos - i.nodeSize) : n)) : ii ? ka(e, new T(e.state.doc.resolve(t < 0 ? o : o + i.nodeSize))) : !1 : !1;
		}
	} else if (r instanceof E && r.node.isInline) return ka(e, new T(t > 0 ? r.$to : r.$from));
	else {
		let n = Oa(e.state, t);
		return n ? ka(e, n) : !1;
	}
...
function Na(e, t) {
	return t < 0 ? Pa(e) : Fa(e);
}
function Pa(e) {
	let t = e.domSelectionRange(), n = t.focusNode, r = t.focusOffset;
	if (!n) return;
	let i, a, o = !1;
	for (Zr && n.nodeType == 1 && r < ja(n) && Ma(n.childNodes[r], -1) && (o = !0);;) if (r > 0) {
		...
		for (; t && Ma(t, -1);) i = n.parentNode, a = k(t), t = t.previousSibling;
		if (t) n = t, r = ja(n);
		else {
...
function Fa(e) {
	...
	for (;;) if (r < i) {
		...
		let t = n.nextSibling;
		for (; t && Ma(t, 1);) a = t.parentNode, o = k(t) + 1, t = t.nextSibling;
		if (t) n = t, r = 0, i = ja(n);
		else {
			if (n = n.parentNode, n == e.dom) break;
			r = i = 0;
...
function za(e, t, n) {
	if (t.nodeType != 3) {
		let e, r;
		(r = La(t, n)) ? (t = r, n = 0) : (e = Ra(t, n)) && (t = e, n = e.nodeValue.length);
	}
...
function Ba(e, t) {
	...
	if (!(j || ni) && n.parent.inlineContent) {
...
function Va(e, t, n) {
	let r = e.state.selection;
	if (r instanceof T && !r.empty || n.indexOf("s") > -1 || ti && n.indexOf("m") > -1) return !1;
	let { $from: i, $to: a } = r;
	if (!i.parent.inlineContent || e.endOfTextblock(t < 0 ? "up" : "down")) {
		let n = Oa(e.state, t);
		if (n && n instanceof E) return ka(e, n);
	}
...
function Wa(e) {
	...
	if (t && t.nodeType == 1 && n == 0 && t.firstChild && t.firstChild.contentEditable == "false") {
		let n = t.firstChild;
		Ua(e, n, "true"), setTimeout(() => Ua(e, n, "false"), 20);
	}
	return !1;
}
function Ga(e) {
...
function Ka(e, t) {
	let n = t.keyCode, r = Ga(t);
	if (n == 8 || ti && n == 72 && r == "c") return Ha(e, -1) || Na(e, -1);
	if (n == 46 && !t.shiftKey || ti && n == 68 && r == "c") return Ha(e, 1) || Na(e, 1);
	if (n == 13 || n == 27) return !0;
	if (n == 37 || ti && n == 66 && r == "c") {
		let t = n == 37 ? Ba(e, e.state.selection.from) == "ltr" ? -1 : 1 : -1;
		return Aa(e, t, r) || Na(e, t);
	} else if (n == 39 || ti && n == 70 && r == "c") {
		let t = n == 39 ? Ba(e, e.state.selection.from) == "ltr" ? 1 : -1 : 1;
		return Aa(e, t, r) || Na(e, t);
	} else if (n == 38 || ti && n == 80 && r == "c") return Va(e, -1, r) || Na(e, -1);
	else if (n == 40 || ti && n == 78 && r == "c") return Wa(e) || Va(e, 1, r) || Na(e, 1);
	else if (r == (ti ? "m" : "c") && (n == 66 || n == 73 || n == 89 || n == 90)) return !0;
	return !1;
}
function qa(e, t) {
	...
	for (; l && l.nodeType == 1 && (u = no[l.nodeName.toLowerCase()]);) {
...
function Ja(e, t, n, r, i) {
	...
	if (c ||= (e.someProp("clipboardParser") || e.someProp("domParser") || Re.fromSchema(e.state.schema)).parseSlice(s, {
		...
		context: i,
		ruleFromNode(e) {
			return e.nodeName == "BR" && !e.nextSibling && e.parentNode && !Ya.test(e.parentNode.nodeName) ? { ignore: !0 } : null;
		}
	}), f) c = lo(to(c, +f[1], +f[2]), f[4]);
	else if (c = d.maxOpen(Xa(c.content, i), !0), c.openStart || c.openEnd) {
		let e = 0, t = 0;
...
function Xa(e, t) {
	...
	for (let n = t.depth; n >= 0; n--) {
		...
		if (e.forEach((e) => {
			...
			if (!t) return o = null;
			if (n = o.length && i.length && Qa(t, i, e, o[o.length - 1], 0)) o[o.length - 1] = n;
			else {
				o.length && (o[o.length - 1] = $a(o[o.length - 1], i.length));
				let n = Za(e, t);
...
function Qa(e, t, n, r, i) {
	if (i < e.length && i < t.length && e[i] == t[i]) {
		let o = Qa(e, t, n, r.lastChild, i + 1);
		if (o) return r.copy(r.content.replaceChild(r.childCount - 1, o));
		if (r.contentMatchAt(r.childCount).matchType(i == e.length - 1 ? n.type : e[i + 1])) return r.copy(r.content.append(a.from(Za(n, e, i + 1))));
	}
}
function $a(e, t) {
	if (t == 0) return e;
	let n = e.content.replaceChild(e.childCount - 1, $a(e.lastChild, t - 1)), r = e.contentMatchAt(e.childCount).fillBefore(a.empty, !0);
	return e.copy(n.append(r));
}
function eo(e, t, n, r, i, o) {
	let s = t < 0 ? e.firstChild : e.lastChild, c = s.content;
	return e.childCount > 1 && (o = 0), i < r - 1 && (c = eo(c, t, n, r, i + 1, o)), i >= n && (c = t < 0 ? s.contentMatchAt(0).fillBefore(c, o <= i).append(c) : c.append(s.contentMatchAt(s.childCount).fillBefore(a.empty, !0))), e.replaceChild(t < 0 ? 0 : e.childCount - 1, s.copy(c));
}
function to(e, t, n) {
	return t < e.openStart && (e = new d(eo(e.content, -1, t, e.openStart, 0, e.openEnd), t, e.openEnd)), n < e.openEnd && (e = new d(eo(e.content, 1, n, e.openEnd, 0, 0), e.openStart, n)), e;
}
var no = {
	thead: ["table"],
	tbody: ["table"],
...
function io() {
	return ro ||= document.implementation.createHTMLDocument("title");
}
var ao = null;
function oo(e) {
...
function so(e) {
	...
	let n = io().createElement("div"), r = /<([a-z][^>\s]+)/i.exec(e), i;
	if ((i = r && no[r[1].toLowerCase()]) && (e = i.map((e) => "<" + e + ">").join("") + e + i.map((e) => "</" + e + ">").reverse().join("")), n.innerHTML = oo(e), i) for (let e = 0; e < i.length; e++) n = n.querySelector(i[e]) || n;
	return n;
}
function co(e) {
...
function po(e) {
	for (let t in N) {
		...
		e.dom.addEventListener(t, e.input.eventHandlers[t] = (t) => {
			vo(e, t) && !_o(e, t) && (e.editable || !(t.type in P)) && n(e, t);
		}, uo[t] ? { passive: !0 } : void 0);
	}
	M && e.dom.addEventListener("input", () => null), go(e);
}
function mo(e, t) {
...
function yo(e, t) {
	!_o(e, t) && N[t.type] && (e.editable || !(t.type in P)) && N[t.type](e, t);
}
P.keydown = (e, t) => {
	let n = t;
	if (e.input.shiftKey = n.keyCode == 16 || n.shiftKey, !Io(e) && (e.input.lastKeyCode = n.keyCode, e.input.lastKeyCodeTime = Date.now(), !(ri && j && n.keyCode == 13))) if (n.keyCode != 229 && e.domObserver.forceFlush(), ei && n.keyCode == 13 && !n.ctrlKey && !n.altKey && !n.metaKey) {
		let t = Date.now();
	...
	} else e.someProp("handleKeyDown", (t) => t(e, n)) || Ka(e, n) ? n.preventDefault() : mo(e, "key");
}, P.keyup = (e, t) => {
	t.keyCode == 16 && (e.input.shiftKey = !1);
}, P.keypress = (e, t) => {
	let n = t;
	if (Io(e) || !n.charCode || n.ctrlKey && !n.altKey || ti && n.metaKey) return;
...
var No = class {
	...
	constructor(e, t, n, r) {
		...
		super.done(), this.mightDrag && this.target && (this.view.domObserver.stop(), this.mightDrag.addAttr && this.target.removeAttribute("draggable"), this.mightDrag.setUneditable && this.target.removeAttribute("contentEditable"), this.view.domObserver.start()), this.delayedSelectionSync && setTimeout(() => {
			this.view.isDestroyed || ha(this.view);
		});
	}
	up(e) {
		if (this.done(), !this.view.dom.contains(e.target)) return;
		let t = this.pos;
		this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(bo(e))), this.updateAllowDefault(e), this.allowDefault || !t ? mo(this.view, "pointer") : Eo(this.view, t.pos, t.inside, e, this.selectNode) ? e.preventDefault() : e.button == 0 && (this.flushed || M && this.mightDrag && !this.mightDrag.node.isAtom || j && !this.view.state.selection.visible && Math.min(Math.abs(t.pos - this.view.state.selection.from), Math.abs(t.pos - this.view.state.selection.to)) <= 2) ? (Co(this.view, w.near(this.view.state.doc.resolve(t.pos)), "pointer"), e.preventDefault()) : mo(this.view, "pointer");
	}
	move(e) {
...
}, N.contextmenu = (e) => jo(e);
function Io(e, t) {
	return e.composing ? !0 : M && Math.abs(Date.now() - e.input.compositionEndedAt) < 500 ? (e.input.compositionEndedAt = -2e8, !0) : !1;
}
var Lo = ri ? 5e3 : -1;
P.compositionstart = P.compositionupdate = (e) => {
	if (!e.composing) {
		e.domObserver.flush();
		let { state: t } = e, n = t.selection.$to;
		if (t.selection instanceof T && (t.storedMarks || !n.textOffset && n.parentOffset && n.nodeBefore.marks.some((e) => e.type.spec.inclusive === !1) || j && ni && Ro(e))) e.markCursor = e.state.storedMarks || n.marks(), Ho(e, !0), e.markCursor = null;
		else if (Ho(e, !t.selection.empty), Zr && t.selection.empty && n.parentOffset && !n.textOffset && n.nodeBefore.marks.length) {
			let t = e.domSelectionRange();
...
function Ho(e, t = !1) {
	if (!(ri && e.domObserver.flushingSoon >= 0)) {
		if (e.domObserver.forceFlush(), Bo(e), t || e.docView && e.docView.dirty) {
			let n = pa(e), r = e.state.selection;
...
var Wo = A && Xr < 15 || ei && ai < 604;
N.copy = P.cut = (e, t) => {
	let n = t, r = e.state.selection, i = n.type == "cut";
	if (r.empty) return;
	let a = Wo ? null : n.clipboardData, { dom: o, text: s } = qa(e, r.content());
...
N.dragstart = (e, t) => {
	...
	(!n.dataTransfer.files.length || !j || $r > 120) && n.dataTransfer.clearData(), n.dataTransfer.setData(Wo ? "Text" : "text/html", s.innerHTML), n.dataTransfer.effectAllowed = "copyMove", Wo || n.dataTransfer.setData("text/plain", c), e.dragging = new Yo(l, Zo(e, n), o);
}, N.dragend = (e) => {
	let t = e.dragging;
	window.setTimeout(() => {
		e.dragging == t && (e.dragging = null);
	}, 50);
}, P.dragover = P.dragenter = (e, t) => t.preventDefault(), P.drop = (e, t) => {
	try {
		Qo(e, t, e.dragging);
	} finally {
		e.dragging = null;
...
function Qo(e, t, n) {
	...
	a ? e.someProp("transformPasted", (t) => {
		a = t(a, e, !1);
	}) : a = Ja(e, Jo(t.dataTransfer), Wo ? null : t.dataTransfer.getData("text/html"), !1, i);
	let o = !!(n && Zo(e, t));
	...
	if (u && E.isSelectable(a.content.firstChild) && p.nodeAfter && p.nodeAfter.sameMarkup(a.content.firstChild)) c.setSelection(new E(p));
		...
		c.mapping.maps[c.mapping.maps.length - 1].forEach((e, n, r, i) => t = i), c.setSelection(wa(e, p, c.doc.resolve(t)));
	}
...
N.focus = (e) => {
	e.input.lastFocus = Date.now(), e.focused || (e.domObserver.stop(), e.dom.classList.add("ProseMirror-focused"), e.domObserver.start(), e.focused = !0, setTimeout(() => {
		e.docView && e.hasFocus() && !e.domObserver.currentSelection.eq(e.domSelectionRange()) && ha(e);
	}, 20));
}, N.blur = (e, t) => {
	let n = t;
	...
	if (j && ri && t.inputType == "deleteContentBackward") {
...
var es = class e {
	...
	map(e, t, n) {
		return this == I || e.maps.length == 0 ? this : this.mapInner(e, t, 0, 0, n || as);
	}
	mapInner(t, n, r, i, a) {
		let o;
		...
		return this.children.length ? cs(this.children, o || [], t, n, r, i, a) : o ? new e(o.sort(ms), is) : I;
	}
	add(t, n) {
		return n.length ? this == I ? e.create(t, n) : this.addInner(t, n, 0) : this;
	}
	addInner(t, n, r) {
		let i, a = 0;
		t.forEach((e, t) => {
	...
	remove(e) {
		return e.length == 0 || this == I ? this : this.removeInner(e, 0);
	}
	removeInner(t, n) {
...
F.empty = new F([], []), F.removeOverlap = hs;
var I = F.empty, ss = class e {
	constructor(e) {
		this.members = e;
	}
	map(t, n) {
	...
	forChild(t, n) {
		...
		for (let i = 0; i < this.members.length; i++) {
			...
			a != I && (a instanceof e ? r = r.concat(a.members) : r.push(a));
		}
		return e.from(r);
	}
	eq(t) {
	...
	static from(t) {
		switch (t.length) {
			case 0: return I;
			case 1: return t[0];
			default: return new e(t.every((e) => e instanceof F) ? t : t.reduce((e, t) => e.concat(t instanceof F ? t : t.members), []));
		}
	}
	forEachSet(e) {
...
function cs(e, t, n, r, i, a, o) {
	...
	for (let t = 0; t < s.length; t += 3) if (s[t + 1] < 0) {
		...
		if (m && p == u && p + m.nodeSize == d) {
			...
			r == I ? (s[t + 1] = -2, c = !0) : (s[t] = u, s[t + 1] = d, s[t + 2] = r);
		} else c = !0;
	}
	if (c) {
...
function _s(e) {
	...
	return e.someProp("decorations", (n) => {
		let r = n(e.state);
		r && r != I && t.push(r);
	}), e.cursorWrapper && t.push(F.create(e.state.doc, [e.cursorWrapper.deco])), ss.from(t);
}
var vs = {
	childList: !0,
	characterData: !0,
	...
	constructor(e, t) {
		this.view = e, this.handleDOMChange = t, this.queue = [], this.flushingSoon = -1, this.observer = null, this.currentSelection = new bs(), this.onCharData = null, this.suppressingSelectionUpdates = !1, this.lastChangedTextNode = null, this.observer = window.MutationObserver && new window.MutationObserver((t) => {
			...
			A && Xr <= 11 && t.some((e) => e.type == "childList" && e.removedNodes.length || e.type == "characterData" && e.oldValue.length > e.target.nodeValue.length) ? this.flushSoon() : M && e.composing && t.some((e) => e.type == "childList" && e.target.nodeName == "TR") ? (e.input.badSafariComposition = !0, this.flushSoon()) : this.flush();
	...
	onSelectionChange() {
		if (Ta(this.view)) {
			if (this.suppressingSelectionUpdates) return ha(this.view);
			if (A && Xr <= 11 && !this.view.state.selection.empty) {
	...
	flush() {
		...
		t.length && (this.queue = []);
		let n = e.domSelectionRange(), r = !this.suppressingSelectionUpdates && !this.currentSelection.eq(n) && Ta(e) && !this.ignoreSelectionChange(n), i = -1, a = -1, o = !1, s = [];
		...
		let c = null;
		i < 0 && r && e.input.lastFocus > Date.now() - 200 && Math.max(e.input.lastTouch, e.input.lastClick.time) < Date.now() - 300 && Br(n) && (c = pa(e)) && c.eq(w.near(e.state.doc.resolve(0), 1)) ? (e.input.lastFocus = 0, ha(e), this.currentSelection.set(n), e.scrollToSelection()) : (i > -1 || r) && (i > -1 && (e.docView.markDirty(i, a), ws(e)), e.input.badSafariComposition && (e.input.badSafariComposition = !1, Os(e, s)), this.handleDOMChange(i, a, o, s), e.docView && e.docView.dirty ? e.updateState(e.state) : this.currentSelection.eq(n) || ha(e), this.currentSelection.set(n));
	}
	registerMutation(e, t) {
		...
		if (e.type == "childList") {
			...
			if (A && Xr <= 11 && e.addedNodes.length) for (let t = 0; t < e.addedNodes.length; t++) {
...
function ws(e) {
	if (!Ss.has(e) && (Ss.set(e, null), [
		...
		if (e.requiresGeckoHackNode = Zr, Cs) return;
...
function ks(e, t, n) {
	...
	})), j && e.input.lastKeyCode === 8) for (let e = a; e > i; e--) {
...
function As(e) {
	...
	if (e.nodeName == "BR" && e.parentNode) {
		if (M && /^(ul|ol)$/i.test(e.parentNode.nodeName)) {
			let e = document.createElement("div");
			return e.appendChild(document.createElement("li")), { skip: e };
		} else if (e.parentNode.lastChild == e || M && /^(tr|table)$/i.test(e.parentNode.nodeName)) return { ignore: !0 };
	} else if (e.nodeName == "IMG" && e.getAttribute("mark-placeholder")) return { ignore: !0 };
	return null;
}
var js = /^(a|abbr|acronym|b|bd[io]|big|br|button|cite|code|data(list)?|del|dfn|em|i|img|ins|kbd|label|map|mark|meter|output|q|ruby|s|samp|small|span|strong|su[bp]|time|u|tt|var)$/i;
function Ms(e, t, n, r, i) {
	let a = e.input.compositionPendingChanges || (e.composing ? e.input.compositionID : 0);
	if (e.input.compositionPendingChanges = 0, t < 0) {
		let t = e.input.lastSelectionTime > Date.now() - 50 ? e.input.lastSelectionOrigin : null, n = pa(e, t);
		if (n && !e.state.selection.eq(n)) {
			if (j && ri && e.input.lastKeyCode === 13 && Date.now() - 100 < e.input.lastKeyCodeTime && e.someProp("handleKeyDown", (t) => t(e, Vr(13, "Enter")))) return;
	...
	let c = e.state.selection, l = ks(e, t, n), u = e.state.doc, d = u.slice(l.from, l.to), f, p;
	...
	if (m && e.input.domChangeCount++, (ei && e.input.lastIOSEnter > Date.now() - 225 || ri) && i.some((e) => e.nodeType == 1 && !js.test(e.nodeName)) && (!m || m.endA >= m.endB) && e.someProp("handleKeyDown", (t) => t(e, Vr(13, "Enter")))) {
	...
	e.state.selection.from < e.state.selection.to && m.start == m.endB && e.state.selection instanceof T && (m.start > e.state.selection.from && m.start <= e.state.selection.from + 2 && e.state.selection.from >= l.from ? m.start = e.state.selection.from : m.endA < e.state.selection.to && m.endA >= e.state.selection.to - 2 && e.state.selection.to <= l.to && (m.endB += e.state.selection.to - m.endA, m.endA = e.state.selection.to)), A && Xr <= 11 && m.endB == m.start + 1 && m.endA == m.start && m.start > l.from && l.doc.textBetween(m.start - l.from - 1, m.start - l.from + 1) == " \xA0" && (m.start--, m.endA--, m.endB--);
	...
	if ((ei && e.input.lastIOSEnter > Date.now() - 225 && (!ee || i.some((e) => e.nodeName == "DIV" || e.nodeName == "P")) || !ee && h.pos < l.doc.content.size && (!h.sameParent(g) || !h.parent.inlineContent) && h.pos < g.pos && !/\S/.test(l.doc.textBetween(h.pos, g.pos, "", ""))) && e.someProp("handleKeyDown", (t) => t(e, Vr(13, "Enter")))) {
		e.input.lastIOSEnter = 0;
		return;
	}
	if (e.state.selection.anchor > m.start && Fs(u, m.start, m.endA, h, g) && e.someProp("handleKeyDown", (t) => t(e, Vr(8, "Backspace")))) {
		ri && j && e.domObserver.suppressSelectionUpdates();
		return;
	}
	j && m.endB == m.start && (e.input.lastChromeDelete = Date.now()), ri && !ee && h.start() != g.start() && g.parentOffset == 0 && h.depth == g.depth && l.sel && l.sel.anchor == l.sel.head && l.sel.head == m.endA && (m.endB -= 2, g = l.doc.resolveNoCache(m.endB - l.from), setTimeout(() => {
	...
	let v = m.start, y = m.endA, b = (t) => {
		...
		if (l.sel) {
			...
			t && !(j && e.composing && t.empty && (m.start != m.endB || e.input.lastChromeDelete < Date.now() - 100) && (t.head == v || t.head == n.mapping.map(y) - 1) || A && t.empty && t.head == v) && n.setSelection(t);
		}
		return a && n.setMeta("composition", a), n.scrollIntoView();
	}, te;
	if (ee) if (h.pos == g.pos) {
		A && Xr <= 11 && h.parentOffset == 0 && (e.domObserver.suppressSelectionUpdates(), setTimeout(() => ha(e), 20));
...
function Ns(e, t, n) {
	return Math.max(n.anchor, n.head) > t.content.size ? null : wa(e, t.resolve(n.anchor), t.resolve(n.head));
}
function Ps(e, t) {
...
var Rs = class {
	...
	updateStateInner(e, t) {
		...
		let u = c == "preserve" && i && this.dom.style.overflowAnchor == null && ui(this);
		if (i) {
			this.domObserver.stop();
			let t = l && (A || j) && !this.composing && !n.selection.empty && !e.selection.empty && Hs(n.selection, e.selection);
			if (l) {
				let n = j ? this.trackWrites = this.domSelectionRange().focusNode : null;
				this.composing && (this.input.compositionNode = Vo(this)), (r || !this.docView.update(e.doc, s, o, this)) && (this.docView.updateOuterDeco(s), this.docView.destroy(), this.docView = qi(e.doc, s, o, this.dom, this)), n && (!this.trackWrites || !this.dom.contains(this.trackWrites)) && (t = !0);
			}
			let i = this.input.mouseDown;
			t || !(i && this.domObserver.currentSelection.eq(this.domSelectionRange()) && Da(this) && i.delaySelUpdate()) ? ha(this, t) : (Sa(this, e.selection), this.domObserver.setCurSelection()), this.domObserver.start();
		}
		this.updatePluginViews(n), this.dragging?.node && !n.doc.eq(e.doc) && this.updateDraggedNode(this.dragging, n), c == "reset" ? this.dom.scrollTop = 0 : c == "to selection" ? this.scrollToSelection() : u && fi(u);
	}
	scrollToSelection() {
	...
	focus() {
		this.domObserver.stop(), this.editable && hi(this.dom), ha(this), this.domObserver.start();
	}
	get root() {
		let e = this._root;
		if (e == null) {
	...
	domSelectionRange() {
		...
		return e ? M && this.root.nodeType === 11 && Hr(this.dom.ownerDocument) == this.dom && Es(this, e) || e : {
			focusNode: null,
			focusOffset: 0,
			anchorNode: null,
			anchorOffset: 0
...
for (var Ks = {
	...
	221: "}",
	222: "\""
}, Js = typeof navigator < "u" && /Mac/.test(navigator.platform), Ys = typeof navigator < "u" && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent), L = 0; L < 10; L++) Ks[48 + L] = Ks[96 + L] = String(L);
for (var L = 1; L <= 24; L++) Ks[L + 111] = "F" + L;
for (var L = 65; L <= 90; L++) Ks[L] = String.fromCharCode(L + 32), qs[L] = String.fromCharCode(L);
...
oc(lc, {
	...
	scrollIntoView: () => pl,
	selectAll: () => ml,
	selectNodeBackward: () => hl,
	selectNodeForward: () => gl,
	selectParentNode: () => _l,
	selectTextblockEnd: () => vl,
...
var _c = (e) => ({ tr: t, state: n, dispatch: r }) => {
	...
	let { from: i, to: a } = xc(n, r, e.schema);
...
function Ec(e, t, n = { strict: !0 }) {
	let r = Object.keys(t);
	return r.length ? r.every((r) => n.strict ? t[r] === e[r] : Tc(t[r]) ? t[r].test(e[r]) : t[r] === e[r]) : !0;
}
function Dc(e, t, n = {}) {
...
var Kc = (e) => !("type" in e), qc = (e, t, n) => ({ tr: r, dispatch: i, editor: o }) => {
	...
	return !0;
}, Jc = () => ({ state: e, dispatch: t }) => Zn(e, t), Yc = () => ({ state: e, dispatch: t }) => Qn(e, t), Xc = () => ({ state: e, dispatch: t }) => Bn(e, t), Zc = () => ({ state: e, dispatch: t }) => Jn(e, t), Qc = () => ({ state: e, dispatch: t, tr: n }) => {
	try {
...
}, el = () => ({ state: e, dispatch: t }) => Vn(e, t), tl = () => ({ state: e, dispatch: t }) => Hn(e, t);
function nl() {
...
function rl(e) {
	...
	for (let e = 0; e < t.length - 1; e += 1) {
		...
		else if (/^mod$/i.test(n)) Lc() || nl() ? o = !0 : i = !0;
		else throw Error(`Unrecognized modifier name: ${n}`);
	}
	return r && (n = `Alt-${n}`), i && (n = `Ctrl-${n}`), o && (n = `Meta-${n}`), a && (n = `Shift-${n}`), n;
}
var il = (e) => ({ editor: t, view: n, tr: r, dispatch: i }) => {
	let a = rl(e).split(/-(?!$)/), o = a.find((e) => ![
		"Alt",
		"Ctrl",
		"Meta",
		"Shift"
...
function al(e, t, n = {}) {
	...
	let c = i - r, l = s.filter((e) => o ? o.name === e.node.type.name : !0).filter((e) => Ec(e.node.attrs, n, { strict: !1 }));
	return a ? !!l.length : l.reduce((e, t) => e + t.to - t.from, 0) >= c;
}
var ol = (e, t = {}) => ({ state: n, dispatch: r }) => al(n, R(e, n.schema), t) ? $n(n, r) : !1, sl = () => ({ state: e, dispatch: t }) => ir(e, t), cl = (e) => ({ state: t, dispatch: n }) => wr(R(e, t.schema))(t, n), ll = () => ({ state: e, dispatch: t }) => er(e, t);
function ul(e, t) {
...
var fl = (e, t) => ({ tr: n, state: r, dispatch: i }) => {
	let a = null, o = null, s = ul(typeof e == "string" ? e : e.name, r.schema);
	if (!s) return !1;
	s === "node" && (a = R(e, r.schema)), s === "mark" && (o = Ac(e, r.schema));
	let c = !1;
	return n.selection.ranges.forEach((e) => {
		r.doc.nodesBetween(e.$from.pos, e.$to.pos, (e, r) => {
			a && a === e.type && (c = !0, i && n.setNodeMarkup(r, void 0, dl(e.attrs, t))), o && e.marks.length && e.marks.forEach((a) => {
				o === a.type && (c = !0, i && n.addMark(r, r + e.nodeSize, o.create(dl(a.attrs, t))));
			});
		});
	}), c;
}, pl = () => ({ tr: e, dispatch: t }) => (t && e.scrollIntoView(), !0), ml = () => ({ tr: e, dispatch: t }) => {
	if (t) {
		let t = new Sn(e.doc);
		e.setSelection(t);
	}
	return !0;
}, hl = () => ({ state: e, dispatch: t }) => Gn(e, t), gl = () => ({ state: e, dispatch: t }) => Yn(e, t), _l = () => ({ state: e, dispatch: t }) => sr(e, t), vl = () => ({ state: e, dispatch: t }) => pr(e, t), yl = () => ({ state: e, dispatch: t }) => fr(e, t);
function bl(e, t, n = {}, r = {}) {
	return Wc(e, t, {
		slice: !1,
		parseOptions: n,
...
var xl = (e, { errorOnInvalidContent: t, emitUpdate: n = !0, parseOptions: r = {} } = {}) => ({ editor: i, tr: a, dispatch: o, commands: s }) => {
	let { doc: c } = a;
	if (r.preserveWhitespace !== "full") {
		let s = bl(e, i.schema, r, { errorOnInvalidContent: t ?? i.options.enableContentCheck });
...
function Nl(e) {
	let t = [], { nodeExtensions: n, markExtensions: r } = Ml(e), i = [...n, ...r], a = {
		default: null,
		validate: void 0,
		rendered: !0,
		renderHTML: null,
...
function Rl(e, t) {
	return "style" in e ? e : {
		...
		getAttrs: (n) => {
			...
			if (r === !1) return !1;
			let i = t.reduce((e, t) => {
				let r = t.attribute.parseHTML ? t.attribute.parseHTML(n) : Ll(n.getAttribute(t.name));
				return r == null ? e : {
					...e,
					[t.name]: r
				};
...
function zl(e) {
	return Object.fromEntries(Object.entries(e).filter(([e, t]) => e === "attrs" && jl(t) ? !1 : t != null));
}
function Bl(e) {
	let t = {};
...
function Vl(e, t) {
	let n = Nl(e), { nodeExtensions: r, markExtensions: i } = Ml(e);
	return new Pe({
		...
		nodes: Object.fromEntries(r.map((r) => {
			let i = n.filter((e) => e.type === r.name), a = {
				...
				attrs: Object.fromEntries(i.map(Bl))
			}), s = B(z(r, "parseHTML", a));
			s && (o.parseDOM = s.map((e) => Rl(e, i)));
			let c = z(r, "renderHTML", a);
			c && (o.toDOM = (e) => c({
				node: e,
				HTMLAttributes: Il(e, i)
			}));
...
function Wl(e) {
	let t = Ul(Ol(e)), n = Hl(t.map((e) => e.name));
...
function Yl(e, t) {
	let n = ul(typeof t == "string" ? t : t.name, e.schema);
	return n === "node" ? Jl(e, t) : n === "mark" ? Sl(e, t) : {};
}
function Xl(e, t = JSON.stringify) {
	let n = {};
	return e.filter((e) => {
		let r = t(e);
...
function iu(e, t, n = {}) {
	...
	if (r) return !!(e.storedMarks || e.selection.$from.marks()).filter((e) => a ? a.name === e.type.name : !0).find((e) => Ec(e.attrs, n, { strict: !1 }));
	let o = 0, s = [];
	...
	let c = s.filter((e) => a ? a.name === e.mark.type.name : !0).filter((e) => Ec(e.mark.attrs, n, { strict: !1 })).reduce((e, t) => e + t.to - t.from, 0), l = s.filter((e) => a ? e.mark.type !== a && e.mark.type.excludes(a) : !0).reduce((e, t) => e + t.to - t.from, 0);
	return (c > 0 ? c + l : c) >= o;
}
function au(e, t, n = {}) {
	if (!t) return al(e, null, n) || iu(e, null, n);
	let r = ul(t, e.schema);
	return r === "node" ? al(e, t, n) : r === "mark" ? iu(e, t, n) : !1;
}
var ou = (e, t) => {
	let { $from: n, $to: r, $anchor: i } = e.selection;
	if (t) {
		let n = Dl((e) => e.type.name === t)(e.selection);
		if (!n) return !1;
...
var gu = (e, t = {}) => ({ tr: n, state: r, dispatch: i }) => {
	...
	return hu(r, n, c);
}, _u = (e, t) => ({ tr: n }) => (n.setMeta(e, t), !0), vu = (e, t = {}) => ({ state: n, dispatch: r, chain: i }) => {
	...
	return !0;
}, Su = (e) => ({ state: t, dispatch: n }) => Dr(R(e, t.schema))(t, n);
function Cu(e, t) {
...
var wu = ({ keepMarks: e = !0 } = {}) => ({ tr: t, state: n, dispatch: r, editor: i }) => {
	let { selection: a, doc: o } = t, { $from: s, $to: c } = a, l = i.extensionManager.attributes, u = nu(l, s.node().type.name, s.node().attrs);
	if (a instanceof E && a.node.isBlock) return !s.parentOffset || !Vt(o, s.pos) ? !1 : (r && (e && Cu(n, i.extensionManager.splittableMarks), t.split(s.pos).scrollIntoView()), !0);
	...
	return m;
}, Tu = (e, t = {}) => ({ tr: n, state: r, dispatch: i, editor: o }) => {
	let s = R(e, r.schema), { $from: c, $to: l } = r.selection, u = r.selection.node;
	...
	if (c.parent.content.size === 0 && c.node(-1).childCount === c.indexAfter(-1)) {
		...
		if (i) {
			...
			let i = c.indexAfter(-1) < c.node(-2).childCount ? 1 : c.indexAfter(-2) < c.node(-3).childCount ? 2 : 3, o = {
				...nu(p, c.node().type.name, c.node().attrs),
				...t
...
var Ou = (e, t) => {
	let n = Dl((e) => e.type === t)(e.selection);
	if (!n) return !0;
	let r = e.doc.resolve(Math.max(0, n.pos - 1)).before(n.depth);
	if (r === void 0) return !0;
	let i = e.doc.nodeAt(r);
	return !(n.node.type === i?.type && Ut(e.doc, n.pos)) || !Du(n.node.attrs.type, i?.attrs.type) || e.join(n.pos), !0;
}, ku = (e, t) => {
	let n = Dl((e) => e.type === t)(e.selection);
	if (!n) return !0;
	...
	if (r === void 0) return !0;
	let i = e.doc.nodeAt(r);
	return !(n.node.type === i?.type && Ut(e.doc, r)) || !Du(n.node.attrs.type, i?.attrs.type) || e.join(r), !0;
};
function Au(e) {
...
var ju = (e, t, n, r = {}) => ({ editor: i, tr: a, state: o, dispatch: s, chain: c, commands: l, can: u }) => {
	let { extensions: d, splittableMarks: f } = i.extensionManager, p = R(e, o.schema), m = R(t, o.schema), { selection: h, storedMarks: g } = o, { $from: _, $to: ee } = h, v = _.blockRange(ee), y = g || h.$to.parentOffset && h.$from.marks();
	if (!v) return !1;
	let b = Dl((e) => lu(e.type.name, d))(h), te = h.from === 0 && h.to === o.doc.content.size, ne = o.doc.content.content, re = ne.length === 1 ? ne[0] : null, ie = te && re && lu(re.type.name, d) ? {
		node: re,
		pos: 0,
		depth: 0
	...
	if ((oe || se) && ae) {
		...
		if (lu(ae.node.type.name, d) && p.validContent(ae.node.content)) return c().command(() => (a.setNodeMarkup(ae.pos, p), !0)).command(() => Ou(a, p)).command(() => ku(a, p)).run();
	}
	return !n || !y || !s ? c().command(() => u().wrapInList(p, r) ? !0 : l.clearNodes()).wrapInList(p, r).command(() => Ou(a, p)).command(() => ku(a, p)).run() : c().command(() => {
		let e = u().wrapInList(p, r), t = y.filter((e) => f.includes(e.type.name));
		return a.ensureMarks(t), e ? !0 : l.clearNodes();
	}).wrapInList(p, r).command(() => Ou(a, p)).command(() => ku(a, p)).run();
}, Mu = (e, t = {}, n = {}) => ({ state: r, commands: i }) => {
	let { extendEmptyMarkRange: a = !1 } = n, o = Ac(e, r.schema);
	return iu(r, o, t) ? i.unsetMark(o, { extendEmptyMarkRange: a }) : i.setMark(o, t);
}, Nu = (e, t, n = {}) => ({ state: r, commands: i }) => {
	let a = R(e, r.schema), o = R(t, r.schema), s = al(r, a, n), c;
...
}, Bu = (e, t = {}) => ({ state: n, dispatch: r }) => mr(R(e, n.schema), t)(n, r), Vu = (e, t = {}) => ({ state: n, dispatch: r }) => xr(R(e, n.schema), t)(n, r), Hu = class {
	constructor() {
		this.callbacks = {};
	}
	on(e, t) {
...
function cd(e) {
	...
	return a.forEach((e) => {
		...
		let a = sd(u, e.find);
		if (!a) return;
		let c = s.state.tr, d = sc({
			state: s.state,
			transaction: c
		}), f = {
			from: n - (a[0].length - i.length),
			to: r
		}, { commands: p, chain: m, can: h } = new cc({
			editor: t,
			state: d
		});
		e.handler({
	...
	let { editor: t, rules: n } = e, r = new D({
		state: {
			...
			apply(e, i, o) {
				...
				return c && setTimeout(() => {
					let { text: e } = c;
					e = typeof e == "string" ? e : kl(a.from(e), o.schema);
					let { from: i } = c;
					cd({
						editor: t,
						from: i,
...
function _d(e) {
	...
	return n.map((e) => new D({
		...
		appendTransaction: (t, n, r) => {
			...
			if (p) {
				let { text: t } = f;
				t = typeof t == "string" ? t : kl(a.from(t), r.schema);
...
var vd = class {
	constructor(e, t) {
		this.splittableMarks = [], this.nonClearableMarks = [], this.editor = t, this.baseExtensions = e, this.extensions = Wl(e), this.schema = Vl(this.extensions, t), this.setupExtensions();
	}
	get commands() {
	...
	get plugins() {
		let { editor: e } = this;
		return Ul([...this.extensions].reverse()).flatMap((t) => {
			let n = {
				name: t.name,
				options: t.options,
				storage: this.editor.extensionStorage[t.name],
			...
			if (t.type === "mark" && z(t, "exitable", n) && (a.ArrowRight = () => dd.handleExit({
				editor: e,
				mark: t
			})), i) {
			...
			if (cu(t, e.options.enableInputRules) && s) {
				let t = s();
				if (t && t.length) {
					let n = ld({
						editor: e,
			...
			if (cu(t, e.options.enablePasteRules) && c) {
				let t = c();
				if (t && t.length) {
					let n = _d({
						editor: e,
	...
	get nodeViews() {
		let { editor: e } = this, { nodeExtensions: t } = Ml(this.extensions);
		return Object.fromEntries(t.filter((e) => !!z(e, "addNodeView")).map((t) => {
			...
			return i ? [t.name, (r, a, o, s, c) => i({
				...
				editor: e,
				extension: t,
				HTMLAttributes: Il(r, n)
			})] : [];
		}));
	}
	dispatchTransaction(e) {
		let { editor: t } = this;
		return Ul([...this.extensions].reverse()).reduceRight((e, n) => {
			let r = {
				name: n.name,
				options: n.options,
				storage: this.editor.extensionStorage[n.name],
				editor: t,
				type: tu(n.name, this.schema)
	...
	transformPastedHTML(e) {
		let { editor: t } = this;
		return Ul([...this.extensions]).reduce((e, n) => {
			let r = {
				name: n.name,
				options: n.options,
				storage: this.editor.extensionStorage[n.name],
	...
	get markViews() {
		let { editor: e } = this, { markExtensions: t } = Ml(this.extensions);
	...
	setupExtensions() {
		...
		this.editor.extensionStorage = Object.fromEntries(e.map((e) => [e.name, e.storage])), e.forEach((e) => {
			let t = {
				...
				editor: this.editor,
				type: tu(e.name, this.schema)
			};
			e.type === "mark" && ((B(z(e, "keepOnSplit", t)) ?? !0) && this.splittableMarks.push(e.name), (B(z(e, "clearable", t)) ?? !0) || this.nonClearableMarks.push(e.name));
...
vd.resolve = Wl, vd.sort = Ul, vd.flatten = Ol, oc({}, {
...
var H = class e extends ud {
	...
	addProseMirrorPlugins() {
		return [new D({
			...
			props: { clipboardTextSerializer: () => {
				let { editor: e } = this, { state: t, schema: n } = e, { doc: r, selection: i } = t, a = ql(n), { blockSeparator: o } = this.options, s = {
					...o === void 0 ? {} : { blockSeparator: o },
					textSerializers: a
				};
				return [...i.ranges].sort((e, t) => e.$from.pos - t.$from.pos).map(({ $from: e, $to: t }) => Gl(r, {
					from: e.pos,
					to: t.pos
				}, s)).join(o ?? "\n\n");
			} }
...
}), wd = new O("focusEvents"), Td = H.create({
	name: "focusEvents",
	addProseMirrorPlugins() {
		let { editor: e } = this;
		return [new D({
	...
	constructor(e = {}) {
		...
		let t = this.createDoc(), n = Fc(t, this.options.autofocus);
	...
	injectCSS() {
		this.options.injectCSS && typeof document < "u" && (this.css = Wu(jd, this.options.injectNonce));
	}
	setOptions(e = {}) {
		this.options = {
			...this.options,
	...
	registerPlugin(e, t) {
		let n = Al(t) ? t(e, [...this.state.plugins]) : [...this.state.plugins, e], r = this.state.reconfigure({ plugins: n });
	...
	createDoc() {
		let e;
		try {
			e = bl(this.options.content, this.schema, this.options.parseOptions, { errorOnInvalidContent: this.options.enableContentCheck });
		} catch (t) {
			...
			}), e = bl(this.options.content, this.schema, this.options.parseOptions, { errorOnInvalidContent: !1 });
		}
		return e;
	}
	createView(e) {
	...
	return new od({
		...
		handler: ({ state: t, range: n, match: r }) => {
			...
			if (o) {
				...
				if ($l(n.from, n.to, t.doc).filter((t) => t.mark.type.excluded.find((n) => n === e.type && n !== t.mark.type)).filter((e) => e.to > c).length) return null;
...
function Id(e) {
	return new od({
		...
		handler: ({ state: t, range: n, match: r, chain: i }) => {
			let a = B(e.getAttributes, void 0, r) || {}, o = t.tr.delete(n.from, n.to), s = o.doc.resolve(n.from).blockRange(), c = s && jt(s, e.type, a);
			if (!c) return null;
	...
	return new fd({
		...
		handler: ({ state: t, range: n, match: r, pasteEvent: i }) => {
			...
			if (s) {
				...
				if ($l(n.from, n.to, t.doc).filter((t) => t.mark.type.excluded.find((n) => n === e.type && n !== t.mark.type)).filter((e) => e.to > u).length) return null;
...
Wd.none = [];
var Gd = class extends Error {}, G = class e {
	constructor(e, t, n) {
		this.content = e, this.openStart = t, this.openEnd = n;
	}
	get size() {
...
function tf(e, t, n, r, i) {
	...
	return $d(null, e, i, s), a && o && t.index(i) == n.index(i) ? (Xd(a, o), Qd(ef(a, tf(e, t, n, r, i + 1)), s)) : (a && Qd(ef(a, nf(e, t, i + 1)), s), $d(t, n, i, s), o && Qd(ef(o, nf(n, r, i + 1)), s)), $d(r, null, i, s), new W(s);
}
function nf(e, t, n) {
	let r = [];
	return $d(null, e, n, r), e.depth > n && Qd(ef(Zd(e, t, n + 1), nf(e, t, n + 1)), r), $d(t, null, n, r), new W(r);
}
function rf(e, t) {
	let n = t.depth - e.openStart, r = t.node(n).copy(e.content);
...
Lf.empty = new Lf([]);
var Rf = /* @__PURE__ */ Object.create(null), K = class {
	getMap() {
		return Lf.empty;
	}
	merge(e) {
...
var Bf = class e extends K {
	constructor(e, t, n) {
		super(), this.from = e, this.to = t, this.mark = n;
	}
	apply(e) {
		let t = e.slice(this.from, this.to), n = e.resolve(this.from), r = n.node(n.sharedDepth(this.to)), i = new G(zf(t.content, (e, t) => !e.isAtom || !t.type.allowsMarkType(this.mark.type) ? e : e.mark(this.mark.addToSet(e.marks)), r), t.openStart, t.openEnd);
...
K.jsonID("addMark", Bf);
var Vf = class e extends K {
	constructor(e, t, n) {
		super(), this.from = e, this.to = t, this.mark = n;
	}
	apply(e) {
		let t = e.slice(this.from, this.to), n = new G(zf(t.content, (e) => e.mark(this.mark.removeFromSet(e.marks)), e), t.openStart, t.openEnd);
		return q.fromReplace(e, this.from, this.to, n);
	}
	invert() {
...
K.jsonID("removeMark", Vf);
var Hf = class e extends K {
	constructor(e, t) {
		super(), this.pos = e, this.mark = t;
	}
	apply(e) {
		...
		let n = t.type.create(t.attrs, null, this.mark.addToSet(t.marks));
		return q.fromReplace(e, this.pos, this.pos + 1, new G(W.from(n), 0, +!t.isLeaf));
	}
	invert(t) {
		let n = t.nodeAt(this.pos);
		if (n) {
...
K.jsonID("addNodeMark", Hf);
var Uf = class e extends K {
	constructor(e, t) {
		super(), this.pos = e, this.mark = t;
	}
	apply(e) {
...
K.jsonID("removeNodeMark", Uf);
var Wf = class e extends K {
	constructor(e, t, n, r = !1) {
		super(), this.from = e, this.to = t, this.slice = n, this.structure = r;
	}
	apply(e) {
		return this.structure && Kf(e, this.from, this.to) ? q.fail("Structure replace would overwrite content") : q.fromReplace(e, this.from, this.to, this.slice);
	}
	getMap() {
		return new Lf([
			this.from,
...
Wf.MAP_BIAS = 1, K.jsonID("replace", Wf);
var Gf = class e extends K {
	constructor(e, t, n, r, i, a, o = !1) {
		super(), this.from = e, this.to = t, this.gapFrom = n, this.gapTo = r, this.slice = i, this.insert = a, this.structure = o;
	}
	apply(e) {
		if (this.structure && (Kf(e, this.from, this.gapFrom) || Kf(e, this.gapTo, this.to))) return q.fail("Structure gap-replace would overwrite content");
		let t = e.slice(this.gapFrom, this.gapTo);
		if (t.openStart || t.openEnd) return q.fail("Gap is not a flat range");
		let n = this.slice.insertAt(this.insert, t.content);
		return n ? q.fromReplace(e, this.from, this.to, n) : q.fail("Content does not fit in gap");
	}
	getMap() {
		return new Lf([
			this.from,
...
var qf = class e extends K {
	...
	apply(e) {
		...
		n[this.attr] = this.value;
		let r = t.type.create(n, null, t.marks);
		return q.fromReplace(e, this.pos, this.pos + 1, new G(W.from(r), 0, +!t.isLeaf));
	}
	getMap() {
		return Lf.empty;
	}
...
var Xf = /* @__PURE__ */ Object.create(null), J = class {
	constructor(e, t, n) {
	...
	replace(e, t = G.empty) {
		...
		for (let o = 0; o < a.length; o++) {
			let { $from: s, $to: c } = a[o], l = e.mapping.slice(i);
			e.replaceRange(l.map(s.pos), l.map(c.pos), o ? G.empty : t), o == 0 && sp(e, i, (n ? n.isInline : r && r.isTextblock) ? -1 : 1);
		}
	}
	replaceWith(e, t) {
		let n = e.steps.length, r = this.ranges;
...
var ep = class e extends J {
	...
	static between(t, n, r) {
		...
		return t.parent.inlineContent || (i == 0 ? t = n : (t = (J.findFrom(t, -r, !0) || J.findFrom(t, r, !0)).$anchor, t.pos < n.pos != i < 0 && (t = n))), new e(t, n);
	}
};
J.jsonID("text", ep);
var tp = class e {
...
np.prototype.visible = !1, J.jsonID("node", np);
var rp = class e {
	constructor(e) {
		this.anchor = e;
	}
	...
	resolve(e) {
		let t = e.resolve(this.anchor), n = t.nodeAfter;
		return n && np.isSelectable(n) ? new np(t) : J.near(t);
	}
}, ip = class e extends J {
	constructor(e) {
		super(e.resolve(0), e.resolve(e.content.size));
	}
	replace(e, t = G.empty) {
...
new lp("doc", {
	...
	init(e, t) {
		return e.selection || J.atStart(t.doc);
	},
	apply(e) {
		return e.selection;
	}
...
\`\`\``, n;
	...
	addCommands() {
		return { setHorizontalRule: () => ({ chain: e, state: t }) => {
			if (!Uu(t, t.schema.nodes[this.name])) return !1;
			let { selection: n } = t, { $to: r } = n, i = e();
			return du(n) ? i.insertContentAt(r.pos, { type: this.name }) : i.insertContent({ type: this.name }), i.command(({ state: e, tr: t, dispatch: n }) => {
				if (n) {
...
Yp.groups = {}, Yp.prototype = {
	...
	tr(e, t, n, r) {
		r ||= Yp.groups;
		let i;
		return t && t.j ? i = t : (i = new Yp(t), n && r && qp(t, n, r)), this.jr.push([e, i]), i;
	},
	ts(e, t, n, r) {
...
var Y = (e, t, n, r, i) => e.ta(t, n, r, i), X = (e, t, n, r, i) => e.tr(t, n, r, i), Xp = (e, t, n, r, i) => e.ts(t, n, r, i), Z = (e, t, n, r, i) => e.tt(t, n, r, i), Zp = "WORD", Qp = "UWORD", $p = "ASCIINUMERICAL", em = "ALPHANUMERICAL", tm = "LOCALHOST", nm = "TLD", rm = "UTLD", im = "SCHEME", am = "SLASH_SCHEME", om = "NUM", sm = "WS", cm = "NL", lm = "OPENBRACE", um = "CLOSEBRACE", dm = "OPENBRACKET", fm = "CLOSEBRACKET", pm = "OPENPAREN", mm = "CLOSEPAREN", hm = "OPENANGLEBRACKET", gm = "CLOSEANGLEBRACKET", _m = "FULLWIDTHLEFTPAREN", vm = "FULLWIDTHRIGHTPAREN", ym = "LEFTCORNERBRACKET", bm = "RIGHTCORNERBRACKET", xm = "LEFTWHITECORNERBRACKET", Sm = "RIGHTWHITECORNERBRACKET", Cm = "FULLWIDTHLESSTHAN", wm = "FULLWIDTHGREATERTHAN", Tm = "AMPERSAND", Em = "APOSTROPHE", Dm = "ASTERISK", Om = "AT", km = "BACKSLASH", Am = "BACKTICK", jm = "CARET", Mm = "COLON", Nm = "COMMA", Pm = "DOLLAR", Fm = "DOT", Im = "EQUALS", Lm = "EXCLAMATION", Rm = "HYPHEN", zm = "PERCENT", Bm = "PIPE", Vm = "PLUS", Hm = "POUND", Um = "QUERY", Wm = "QUOTE", Gm = "FULLWIDTHMIDDLEDOT", Km = "SEMI", qm = "SLASH", Jm = "TILDE", Ym = "UNDERSCORE", Xm = "EMOJI", Zm = "SYM", Qm = /*#__PURE__*/ Object.freeze({
	...
	EQUALS: Im,
	EXCLAMATION: Lm,
	FULLWIDTHGREATERTHAN: wm,
	FULLWIDTHLEFTPAREN: _m,
	FULLWIDTHLESSTHAN: Cm,
	FULLWIDTHMIDDLEDOT: Gm,
	FULLWIDTHRIGHTPAREN: vm,
	HYPHEN: Rm,
	LEFTCORNERBRACKET: ym,
	LEFTWHITECORNERBRACKET: xm,
	LOCALHOST: tm,
	NL: cm,
	NUM: om,
	OPENANGLEBRACKET: hm,
	...
	QUERY: Um,
	QUOTE: Wm,
	RIGHTCORNERBRACKET: bm,
	RIGHTWHITECORNERBRACKET: Sm,
	SCHEME: im,
	SEMI: Km,
	SLASH: qm,
	SLASH_SCHEME: am,
	...
	WORD: Zp,
	WS: sm
}), $m = /[a-z]/, eh = /\p{L}/u, th = /\p{Emoji}/u, nh = /\d/, rh = /\s/, ih = "\r", ah = "\n", oh = "️", sh = "‍", ch = "￼", lh = null, uh = null;
function dh(e = []) {
	let t = {};
	Yp.groups = t;
	let n = new Yp();
	lh ??= hh(Pp), uh ??= hh(Fp), Z(n, "'", Em), Z(n, "{", lm), Z(n, "}", um), Z(n, "[", dm), Z(n, "]", fm), Z(n, "(", pm), Z(n, ")", mm), Z(n, "<", hm), Z(n, ">", gm), Z(n, "（", _m), Z(n, "）", vm), Z(n, "「", ym), Z(n, "」", bm), Z(n, "『", xm), Z(n, "』", Sm), Z(n, "＜", Cm), Z(n, "＞", wm), Z(n, "&", Tm), Z(n, "*", Dm), Z(n, "@", Om), Z(n, "`", Am), Z(n, "^", jm), Z(n, ":", Mm), Z(n, ",", Nm), Z(n, "$", Pm), Z(n, ".", Fm), Z(n, "=", Im), Z(n, "!", Lm), Z(n, "-", Rm), Z(n, "%", zm), Z(n, "|", Bm), Z(n, "+", Vm), Z(n, "#", Hm), Z(n, "?", Um), Z(n, "\"", Wm), Z(n, "/", qm), Z(n, ";", Km), Z(n, "~", Jm), Z(n, "_", Ym), Z(n, "\\", km), Z(n, "・", Gm);
	let r = X(n, nh, om, { [Ip]: !0 });
	X(r, nh, r);
	let i = X(r, $m, $p, { [zp]: !0 }), a = X(r, eh, em, { [Bp]: !0 }), o = X(n, $m, Zp, { [Lp]: !0 });
	X(o, nh, i), X(o, $m, o), X(i, nh, i), X(i, $m, i);
	let s = X(n, eh, Qp, { [Rp]: !0 });
	X(s, $m), X(s, nh, a), X(s, eh, s), X(a, nh, a), X(a, $m), X(a, eh, a);
	let c = Z(n, ah, cm, { [Gp]: !0 }), l = Z(n, ih, sm, { [Gp]: !0 }), u = X(n, rh, sm, { [Gp]: !0 });
	Z(n, ch, u), Z(l, ah, c), Z(l, ch, u), X(l, rh, u), Z(u, ih), Z(u, ah), X(u, rh, u), Z(u, ch, u);
	let d = X(n, th, Xm, { [Hp]: !0 });
	Z(d, "#"), X(d, th, d), Z(d, oh, d);
	let f = Z(d, sh);
	Z(f, "#"), X(f, th, d);
	let p = [[$m, o], [nh, i]], m = [
		[$m, null],
	...
	for (let e = 0; e < lh.length; e++) mh(n, lh[e], nm, Zp, p);
	for (let e = 0; e < uh.length; e++) mh(n, uh[e], rm, Qp, m);
	qp(nm, {
		tld: !0,
		ascii: !0
	}, t), qp(rm, {
		utld: !0,
		alpha: !0
	}, t), mh(n, "file", im, Zp, p), mh(n, "mailto", im, Zp, p), mh(n, "http", am, Zp, p), mh(n, "https", am, Zp, p), mh(n, "ftp", am, Zp, p), mh(n, "ftps", am, Zp, p), qp(im, {
		scheme: !0,
		ascii: !0
	}, t), qp(am, {
		slashscheme: !0,
	...
	for (let t = 0; t < e.length; t++) {
		...
		r.indexOf("-") >= 0 ? i[Vp] = !0 : $m.test(r) ? nh.test(r) ? i[zp] = !0 : i[Lp] = !0 : i[Ip] = !0, Xp(n, r, r, i);
	}
	return Xp(n, "localhost", tm, { ascii: !0 }), n.jd = new Yp(Zm), {
		start: n,
		tokens: Object.assign({ groups: t }, Qm)
	};
}
function fh(e, t) {
	let n = ph(t.replace(/[A-Z]/g, (e) => e.toLowerCase())), r = n.length, i = [], a = 0, o = 0;
	for (; o < r;) {
...
function mh(e, t, n, r, i) {
	...
	for (let n = 0; n < o - 1; n++) {
		let o = t[n];
		e.j[o] ? a = e.j[o] : (a = new Yp(r), a.jr = i.slice(), e.j[o] = a), e = a;
	}
	return a = new Yp(n), a.jr = i.slice(), e.j[t[o - 1]] = a, a;
}
function hh(e) {
	let t = [], n = [], r = 0;
	for (; r < e.length;) {
...
function _h(e, t = null) {
	let n = Object.assign({}, gh);
	e && (n = Object.assign(n, e instanceof _h ? e.o : e));
...
_h.prototype = {
	...
	get(e, t, n) {
		...
		return i && (typeof i == "object" ? (i = n.t in i ? i[n.t] : gh[e], typeof i == "function" && r && (i = i(t, n))) : typeof i == "function" && r && (i = i(t, n.t, n)), i);
	},
	getObj(e, t, n) {
		let r = this.o[e];
...
}), Sh = bh("text"), Ch = bh("nl"), wh = bh("url", {
	isLink: !0,
	toHref(e = gh.defaultProtocol) {
		return this.hasProtocol() ? this.v : `${e}://${this.v}`;
	},
	hasProtocol() {
		let e = this.tk;
		return e.length >= 2 && e[0].t !== tm && e[1].t === Mm;
	}
}), Th = (e) => new Yp(e);
function Eh({ groups: e }) {
	...
	Y(f, e.domain, d);
	let p = Th(xh);
	Y(f, e.tld, p), Y(f, e.utld, p), Z(l, tm, p);
	let m = Z(d, Rm);
	Z(m, Rm, m), Y(m, e.domain, d), Y(p, e.domain, d), Z(p, Fm, f), Z(p, Rm, m);
	let h = Z(o, Rm), g = Z(o, Fm);
	Z(h, Rm, h), Y(h, e.domain, o), Y(g, r, a), Y(g, e.domain, o);
	let _ = Th(wh);
	Y(g, e.tld, _), Y(g, e.utld, _), Y(_, e.domain, o), Y(_, r, a), Z(_, Fm, g), Z(_, Rm, h), Z(_, Om, l);
	let ee = Z(_, Mm), v = Th(wh);
	Y(ee, e.numeric, v);
	let y = Th(wh), b = Th();
	Y(y, t, y), Y(y, n, b), Y(b, t, y), Y(b, n, b), Z(_, qm, y), Z(v, qm, y);
	let te = Z(s, Mm), ne = Z(Z(Z(c, Mm), qm), qm);
	Y(s, e.domain, o), Z(s, Fm, g), Z(s, Rm, h), Y(c, e.domain, o), Z(c, Fm, g), Z(c, Rm, h), Y(te, e.domain, y), Z(te, qm, y), Z(te, Um, y), Y(ne, e.domain, y), Y(ne, t, y), Z(ne, qm, y);
	let re = [
		[lm, um],
		[dm, fm],
		[pm, mm],
...
function Dh(e, t, n) {
	...
	for (; i < r;) {
		...
		if (f < 0) i -= u, i < r && (o.push(n[i]), i++);
			...
			o.length > 0 && (a.push(Oh(Sh, t, o)), o = []), i -= f, u -= f;
			let e = d.t, r = n.slice(i - u, i);
			a.push(Oh(e, t, r));
		}
	}
	return o.length > 0 && a.push(Oh(Sh, t, o)), a;
}
function Oh(e, t, n) {
	let r = n[0].s, i = n[n.length - 1].e;
	return new e(t.slice(r, i), n);
}
var kh = typeof console < "u" && console && console.warn || (() => {}), Ah = "until manual call of linkify.init(). Register all schemes and plugins before invoking linkify the first time.", Q = {
	scanner: null,
	parser: null,
	tokenQueue: [],
	pluginQueue: [],
...
function jh() {
	return Yp.groups = {}, Q.scanner = null, Q.parser = null, Q.tokenQueue = [], Q.pluginQueue = [], Q.customSchemes = [], Q.initialized = !1, Q;
}
function Mh(e, t = !1) {
	if (Q.initialized && kh(`linkifyjs: already initialized - will not register custom scheme "${e}" ${Ah}`), !/^[0-9a-z]+(-[0-9a-z]+)*$/.test(e)) throw Error("linkifyjs: incorrect scheme format.\n1. Must only contain digits, lowercase ASCII letters or \"-\"\n2. Cannot start or end with \"-\"\n3. \"-\" cannot repeat");
	Q.customSchemes.push([e, t]);
}
function Nh() {
	Q.scanner = dh(Q.customSchemes);
	for (let e = 0; e < Q.tokenQueue.length; e++) Q.tokenQueue[e][1]({ scanner: Q.scanner });
	Q.parser = Eh(Q.scanner.tokens);
...
function Ph(e) {
	return Q.initialized || Nh(), Dh(Q.parser.start, e, fh(Q.scanner.start, e));
}
Ph.scan = fh;
...
var Ih = "[\0- \xA0 ᠎ -\u2029 　]", Lh = new RegExp(Ih), Rh = RegExp(`${Ih}$`), zh = new RegExp(Ih, "g");
function Bh(e) {
...
function Vh(e) {
	return new D({
		...
		appendTransaction: (t, n, r) => {
			...
			if (!i || a) return;
			let { tr: o } = r;
			if (Ql(Cl(n.doc, [...t])).forEach(({ newRange: t }) => {
				let n = Tl(r.doc, t, (e) => e.isTextblock), i, a;
				...
				if (i && a) {
					let t = a.split(Lh).filter(Boolean);
					if (t.length <= 0) return !1;
					let n = t[t.length - 1], s = i.pos + a.lastIndexOf(n);
					if (!n) return !1;
					let c = Ph(n).map((t) => t.toObject(e.defaultProtocol));
					if (!Bh(c)) return !1;
					c.filter((e) => e.isLink).map((e) => ({
						...
						$l(t.from, t.to, r.doc).some((t) => t.mark.type === e.type) || o.addMark(t.from, t.to, e.type.create({ href: t.href }));
					});
				}
	...
	return new D({
		...
		props: { handleClick: (t, n, r) => {
			...
			if (e.enableClickSelection && (a = e.editor.commands.extendMarkRange(e.type.name)), e.openOnClick) {
				let n = Yl(t.state, e.type.name), r = i.href ?? n.href, o = i.target ?? n.target;
...
function Uh(e) {
	return new D({
		...
		props: { handlePaste: (t, n, r) => {
			...
			let l = Fh(c, { defaultProtocol: e.defaultProtocol }).find((e) => e.isLink && e.value === c);
...
function Wh(e, t) {
	...
	return t && t.forEach((e) => {
		...
		t && n.push(t);
	}), !e || e.replace(zh, "").match(RegExp(`^(?:(?:${n.map((e) => e.replace(/[-/\\^$*+?.()|[\]{}]/g, "\\$&")).join("|")}):|[^a-z]|[a-z0-9+.\\-]+(?:[^a-z+.\\-:]|$))`, "i"));
}
var Gh = dd.create({
	name: "link",
	priority: 1e3,
	...
	addOptions() {
		return {
			...
			isAllowedUri: (e, t) => !!Wh(e, t.protocols),
			validate: (e) => !!e,
			shouldAutoLink: (e) => {
		...
		return [{
			...
			getAttrs: (e) => {
				...
				return !t || !this.options.isAllowedUri(t, {
					defaultValidate: (e) => !!Wh(e, this.options.protocols),
	...
	addPasteRules() {
		return [Ld({
			find: (e) => {
				let t = [];
				if (e) {
					let { protocols: n, defaultProtocol: r } = this.options, i = Fh(e).filter((e) => e.isLink && this.options.isAllowedUri(e.value, {
						defaultValidate: (e) => !!Wh(e, n),
						protocols: n,
						defaultProtocol: r
					}));
	...
	addProseMirrorPlugins() {
		...
		return this.options.autolink && e.push(Vh({
			type: this.type,
			defaultProtocol: this.options.defaultProtocol,
			validate: (e) => this.options.isAllowedUri(e, {
				defaultValidate: (e) => !!Wh(e, t),
				protocols: t,
				defaultProtocol: n
			}),
		...
		})), this.options.linkOnPaste && e.push(Uh({
			editor: this.editor,
			defaultProtocol: this.options.defaultProtocol,
			type: this.type,
			shouldAutoLink: this.options.shouldAutoLink
...
}), Kh = Object.defineProperty, qh = (e, t) => {
	for (var n in t) Kh(e, n, {
		get: t[n],
		enumerable: !0
	});
}, Jh = "listItem", Yh = "textStyle", Xh = /^\s*([-+*])\s$/, Zh = U.create({
	name: "bulletList",
	addOptions() {
		return {
	...
	addCommands() {
		return { toggleBulletList: () => ({ commands: e, chain: t }) => this.options.keepAttributes ? t().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(Jh, this.editor.getAttributes(Yh)).run() : e.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks) };
	},
	addKeyboardShortcuts() {
	...
	addInputRules() {
		...
		return (this.options.keepMarks || this.options.keepAttributes) && (e = Id({
			...
			getAttributes: () => this.editor.getAttributes(Yh),
			editor: this.editor
		})), [e];
	}
}), Qh = (e, t, n) => {
...
}, eg = (e, t, n) => $h(e.state, e.view.dispatch, t, n), tg = (e, t) => H.create({
	name: `${e}BranchingDeleteKeymap`,
	priority: 101,
	addKeyboardShortcuts() {
		let n = () => eg(this.editor, e, t);
		return {
			Delete: n,
			"Mod-Delete": n
		};
	...
	[4, "iv"],
	[1, "i"]
], rg = "abcdefghijklmnopqrstuvwxyz", ig = String.raw`\d+|[ivxlcdmIVXLCDM]+|${"[a-zA-Z]{1,2}"}`;
function ag(e) {
	let t = e, n = "";
	for (let [e, r] of ng) for (; t >= e;) n += r, t -= e;
	return n;
}
function og(e) {
	return ag(e).toUpperCase();
}
function sg(e) {
	let t = e.toLowerCase(), n = 0, r = 0;
	for (; n < t.length;) {
		let e = !1;
		for (let [i, a] of ng) if (t.startsWith(a, n)) {
			r += i, n += a.length, e = !0;
			break;
		}
		if (!e) return 0;
...
function cg(e) {
	...
	let t = sg(e);
	return t <= 0 ? !1 : (e === e.toLowerCase() ? ag(t) : og(t)) === e;
}
function lg(e) {
	let t = e.toLowerCase();
...
function ug(e) {
	if (e <= 26) return rg[e - 1];
	let t = Math.floor((e - 1) / 26) - 1, n = (e - 1) % 26;
	return t < 0 ? rg[n] : rg[t] + rg[n];
}
function dg(e) {
	if (!(!e || /^\d+$/.test(e))) {
		if (cg(e)) return e === e.toLowerCase() ? "i" : "I";
...
function pg(e, t) {
	...
	switch (e) {
		case "a": return ug(t);
		case "A": return ug(t).toUpperCase();
		case "i": return ag(t);
		case "I": return og(t);
...
function _g(e, t, n = ". ") {
	...
	if (!e || e === "1") return `${r}${n}`;
	switch (e) {
		case "a": return `${ug(r)}${n}`;
		case "A": return `${ug(r).toUpperCase()}${n}`;
		case "i": return `${ag(r)}${n}`;
		case "I": return `${og(r)}${n}`;
		default: return `${r}${n}`;
	}
}
function vg(e) {
...
var bg = U.create({
	...
	renderMarkdown: (e, t, n) => rd(e, t, (e) => {
		...
		if (e.parentType === "orderedList") {
			...
			return _g(e.meta?.parentAttrs?.type, t - 1 + (e.index || 0), ". ");
		}
		return "- ";
	}, n),
	addExtensions() {
		return [tg(this.name, [this.options.bulletListTypeName, this.options.orderedListTypeName])];
	},
	addKeyboardShortcuts() {
		return {
...
qh({}, {
	...
	hasListBefore: () => Cg,
	hasListItemAfter: () => Og,
	hasListItemBefore: () => kg,
	listItemHasSubList: () => Ag,
	nextListIsDeeper: () => Tg,
	nextListIsHigher: () => Eg
});
var xg = (e, t) => {
	...
	if (!al(e.state, t) && Cg(e.state, t, n)) {
	...
	return !al(e.state, t) || !su(e.state) ? !1 : e.chain().liftListItem(t).run();
}, Tg = (e, t) => {
	let n = Sg(e, t), r = xg(e, t);
	return !r || !n ? !1 : n > r.depth;
}, Eg = (e, t) => {
	let n = Sg(e, t), r = xg(e, t);
	return !r || !n ? !1 : n < r.depth;
}, Dg = (e, t) => {
	if (!al(e.state, t) || !ou(e.state, t)) return !1;
	let { selection: n } = e.state, { $from: r, $to: i } = n;
	return !n.empty && r.sameParent(i) ? !1 : Tg(t, e.state) ? e.chain().focus(e.state.selection.from + 4).lift(t).joinBackward().run() : Eg(t, e.state) ? e.chain().joinForward().joinBackward().run() : e.commands.joinItemForward();
}, Og = (e, t) => {
		...
		return {
			Delete: ({ editor: e }) => {
				...
				return this.options.listTypes.forEach(({ itemName: n }) => {
					e.state.schema.nodes[n] !== void 0 && Dg(e, n) && (t = !0);
				}), t;
			},
			"Mod-Delete": ({ editor: e }) => {
				let t = !1;
			...
			Backspace: ({ editor: e }) => {
				...
				return this.options.listTypes.forEach(({ itemName: n, wrapperNames: r }) => {
					e.state.schema.nodes[n] !== void 0 && wg(e, n, r) && (t = !0);
				}), t;
			},
...
}), Mg = RegExp(`^(\\s*)(${ig})([.)])\\s+(.*)$`), Ng = RegExp(`^(\\s*)(${ig})([.)])\\s+`), Pg = /^\s/;
function Fg(e) {
	return Mg.test(e.trimStart());
}
function Ig(e) {
	let t = e.trimStart();
	return /^[-+*]\s+/.test(t) || Fg(t) || /^>\s?/.test(t) || /^```/.test(t) || /^~~~/.test(t);
}
function Lg(e) {
	let t = [], n = [], r = !1;
	return e.forEach((e) => {
...
function Rg(e) {
	let t = [], n = 0, r = 0;
	for (; n < e.length;) {
		let i = e[n], a = i.match(Mg);
		if (!a) break;
		let [, o, s, c, l] = a, u = o.length, d = parseInt(s, 10), f = isNaN(d) ? dg(s) : void 0, p = isNaN(d) ? fg(s) : d, m = [l], h = n + 1, g = [i], _ = !1;
		for (; h < e.length;) {
			let t = e[h];
			if (t.match(Mg)) break;
...
function Vg(e, t, n) {
	...
	for (; i < e.length;) {
		let a = e[i];
		if (a.indent === t) {
			let { paragraphLines: o, blockLines: s } = Lg(a.contentLines), c = o.join("\n").trim(), l = [];
			c && l.push({
				type: "paragraph",
				raw: c,
			...
			if (f.length > 0) {
				let e = Vg(f, Math.min(...f.map((e) => e.indent)), n);
				l.push({
					type: "list",
					ordered: !0,
					start: f[0].number,
...
var Ug = "listItem", Wg = "textStyle", Gg = /^(\d+)\.\s$/;
function Kg(e) {
...
var qg = U.create({
	...
	renderHTML({ HTMLAttributes: e }) {
		let { start: t, type: n, ...r } = e, i = V(this.options.HTMLAttributes, r);
	...
	parseMarkdown: (e, t) => {
		...
		let n = e.start || 1, r = e.typeMarker, i = e.items ? Hg(e.items, t) : [], a = {};
	...
	markdownOptions: { indentsContent: !0 },
	addCommands() {
		return { toggleOrderedList: () => ({ commands: e, chain: t }) => this.options.keepAttributes ? t().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(Ug, this.editor.getAttributes(Wg)).run() : e.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks) };
	},
	addKeyboardShortcuts() {
		...
		return ({ node: e, HTMLAttributes: t, getPos: n, editor: r }) => {
			...
			return {
				...
				update: (e) => {
					...
					let t = r.extensionManager.attributes, n = Il(e, t), a = new Set(Object.keys(n)), o = this.options.HTMLAttributes;
					return u.forEach((e) => {
...
H.create({
	...
	addExtensions() {
		let e = [];
		return this.options.bulletList !== !1 && e.push(Zh.configure(this.options.bulletList)), this.options.listItem !== !1 && e.push(bg.configure(this.options.listItem)), this.options.listKeymap !== !1 && e.push(jg.configure(this.options.listKeymap)), this.options.orderedList !== !1 && e.push(qg.configure(this.options.orderedList)), this.options.taskItem !== !1 && e.push(Yg.configure(this.options.taskItem)), this.options.taskList !== !1 && e.push(Xg.configure(this.options.taskList)), e;
	}
});
//#endregion
//#region node_modules/@tiptap/extension-paragraph/dist/index.js
var Zg = "&nbsp;", Qg = "\xA0", $g = U.create({
	name: "paragraph",
	priority: 1e3,
	addOptions() {
		return { HTMLAttributes: {} };
	...
	parseMarkdown: (e, t) => {
		...
		return n.length === 1 && n[0].type === "text" && (n[0].raw === Zg || n[0].text === Zg || n[0].raw === Qg || n[0].text === Qg) && r.length === 1 && r[0].type === "text" && (r[0].text === Zg || r[0].text === Qg) ? t.createNode("paragraph", void 0, []) : t.createNode("paragraph", void 0, r);
	},
	renderMarkdown: (e, t, n) => {
		...
		if (r.length === 0) {
			...
			return n?.previousNode?.type === "paragraph" && e.length === 0 ? Zg : "";
		}
...
}), e_ = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))$/, t_ = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))/g, n_ = dd.create({
	name: "strike",
	addOptions() {
		return { HTMLAttributes: {} };
	},
...
var s_ = class {
	...
	getBookmark() {
		return new l_(this.anchor);
	}
	static valid(e) {
		let t = e.parent;
		if (t.inlineContent || !d_(e) || !f_(e)) return !1;
...
c_.prototype.visible = !1, c_.findFrom = c_.findGapCursorFrom, w.jsonID("gapcursor", c_);
var l_ = class e {
	constructor(e) {
		this.pos = e;
	}
	...
	resolve(e) {
		...
		return c_.valid(t) ? new c_(t) : w.near(t);
	}
};
function u_(e) {
...
function d_(e) {
	for (let t = e.depth; t >= 0; t--) {
		...
		for (let e = r.child(n - 1);; e = e.lastChild) {
			if (e.childCount == 0 && !e.inlineContent || u_(e.type)) return !0;
...
function p_() {
	return new D({ props: {
		...
		createSelectionBetween(e, t, n) {
			return t.pos == n.pos && c_.valid(n) ? new c_(n) : null;
		},
		handleClick: g_,
		handleKeyDown: m_,
		handleDOMEvents: { beforeinput: __ }
	} });
}
var m_ = ic({
	ArrowLeft: h_("horiz", -1),
	ArrowRight: h_("horiz", 1),
	ArrowUp: h_("vert", -1),
	ArrowDown: h_("vert", 1)
});
function h_(e, t) {
	...
	return function(e, r, i) {
		...
		let c = c_.findGapCursorFrom(o, t, s);
		return c ? (r && r(e.tr.setSelection(new c_(c))), !0) : !1;
	};
}
function g_(e, t, n) {
	if (!e || !e.editable) return !1;
	let r = e.state.doc.resolve(t);
	if (!c_.valid(r)) return !1;
	let i = e.posAtCoords({
		left: n.clientX,
		top: n.clientY
	});
	return i && i.inside > -1 && E.isSelectable(e.state.doc.nodeAt(i.inside)) ? !1 : (e.dispatch(e.state.tr.setSelection(new c_(r))), !0);
}
function __(e, t) {
	if (t.inputType != "insertCompositionText" || !(e.state.selection instanceof c_)) return !1;
...
function v_(e) {
	if (!(e.selection instanceof c_)) return null;
	let t = document.createElement("div");
	return t.className = "ProseMirror-gapcursor", F.create(e.doc, [rs.widget(e.selection.head, t, { key: "gapcursor" })]);
}
//#endregion
//#region node_modules/rope-sequence/dist/index.js
var y_ = 200, $ = function() {};
$.prototype.append = function(e) {
	return e.length ? (e = $.from(e), !this.length && e || e.length < y_ && this.leafAppend(e) || this.length < y_ && e.leafPrepend(this) || this.appendInner(e)) : this;
	...
	return e instanceof $ ? e : e && e.length ? new b_(e) : $.empty;
};
var b_ = /* @__PURE__ */ function(e) {
	function t(t) {
	...
	return t.prototype.flatten = function() {
		...
		if (this.length + e.length <= y_) return new t(this.values.concat(e.flatten()));
	}, t.prototype.leafPrepend = function(e) {
		if (this.length + e.length <= y_) return new t(e.flatten().concat(this.values));
...
var x_ = /* @__PURE__ */ function(e) {
	...
	popEvent(t, n) {
		...
		return this.items.forEach((t, n) => {
			...
			if (i) {
				...
				e && o.maybeStep(e).doc && (n = o.mapping.maps[o.mapping.maps.length - 1], l.push(new T_(n, void 0, void 0, l.length + u.length))), a--, n && i.appendMap(n, a);
	...
	addTransform(t, n, r, i) {
		...
		for (let e = 0; e < t.steps.length; e++) {
			let r = t.steps[e].invert(t.docs[e]), l = new T_(t.mapping.maps[e], r, n), u;
			(u = c && c.merge(l)) && (l = u, e ? a.pop() : s = s.slice(0, s.length - 1)), a.push(l), n &&= (o++, void 0), i || (c = l);
		}
		let l = o - r.depth;
		return l > D_ && (s = w_(s, l), o -= l), new e(s.append(a), o);
	}
	remapping(e, t) {
		let n = new gt();
	...
	addMaps(t) {
		return this.eventCount == 0 ? this : new e(this.items.append(t.map((e) => new T_(e))), this.eventCount);
	}
	rebased(t, n) {
		...
		this.items.forEach((e) => {
			...
			if (e.step) {
				...
				l && s++, r.push(new T_(i, o, l));
			} else r.push(new T_(i));
		}, i);
		let l = [];
		for (let e = n; e < o; e++) l.push(new T_(a.maps[e]));
		let u = new e(this.items.slice(0, i).append(l).append(r), s);
		return u.emptyItemCount() > S_ && (u = u.compress(this.items.length - r.length)), u;
	}
	emptyItemCount() {
		let e = 0;
		...
		return this.items.forEach((e, o) => {
			if (o >= t) i.push(e), e.selection && a++;
				...
				if (r--, o && n.appendMap(o, r), t) {
					...
					s && a++;
					let c = new T_(o.invert(), t, s), l, u = i.length - 1;
...
function O_(e, t, n, r) {
	let i = n.getMeta(I_), a;
	if (i) return i.historyState;
	n.getMeta(L_) && (e = new E_(e.done, e.undone, null, 0, -1));
	let o = n.getMeta("appendedTransaction");
	if (n.steps.length == 0) return e;
	if (o && o.getMeta(I_)) return o.getMeta(I_).redo ? new E_(e.done.addTransform(n, void 0, r, F_(t)), e.undone, A_(n.mapping.maps), e.prevTime, e.prevComposition) : new E_(e.done, e.undone.addTransform(n, void 0, r, F_(t)), null, e.prevTime, e.prevComposition);
	if (n.getMeta("addToHistory") !== !1 && !(o && o.getMeta("addToHistory") === !1)) {
		let i = n.getMeta("composition"), a = e.prevTime == 0 || !o && e.prevComposition != i && (e.prevTime < (n.time || 0) - r.newGroupDelay || !k_(n, e.prevRanges)), s = o ? j_(e.prevRanges, n.mapping) : A_(n.mapping.maps);
		return new E_(e.done.addTransform(n, a ? t.selection.getBookmark() : void 0, r, F_(t)), C_.empty, s, n.time, i ?? e.prevComposition);
	} else if (a = n.getMeta("rebased")) return new E_(e.done.rebased(n, a), e.undone.rebased(n, a), j_(e.prevRanges, n.mapping), e.prevTime, e.prevComposition);
	else return new E_(e.done.addMaps(n.mapping.maps), e.undone.addMaps(n.mapping.maps), j_(e.prevRanges, n.mapping), e.prevTime, e.prevComposition);
}
function k_(e, t) {
	if (!t) return !1;
...
function M_(e, t, n) {
	let r = F_(t), i = I_.get(t).spec.config, a = (n ? e.undone : e.done).popEvent(t, r);
	if (!a) return null;
	let o = a.selection.resolve(a.transform.doc), s = (n ? e.done : e.undone).addTransform(a.transform, t.selection.getBookmark(), i, r), c = new E_(n ? s : a.remaining, n ? a.remaining : s, null, 0, -1);
	return a.transform.setSelection(o).setMeta(I_, {
		redo: n,
		historyState: c
	});
}
...
var I_ = new O("history"), L_ = new O("closeHistory");
function R_(e = {}) {
	return e = {
		depth: e.depth || 100,
		...
		state: {
			init() {
				return new E_(C_.empty, C_.empty, null, 0, -1);
			},
			apply(t, n, r) {
				return O_(n, r, t, e);
			}
		...
		props: { handleDOMEvents: { beforeinput(e, t) {
			let n = t.inputType, r = n == "historyUndo" ? B_ : n == "historyRedo" ? V_ : null;
...
}), W_ = "placeholder", G_ = new O("tiptap__placeholder"), K_ = 200;
function q_(e) {
...
function Y_({ editor: e, options: t, dataAttribute: n, doc: r, selection: i }) {
	...
	if (t.showOnlyCurrent && !t.includeChildren) {
		...
		let i = G_.getState(e.state), c = i?.topPos ?? 0, l = i?.bottomPos ?? r.content.size;
		r.nodesBetween(c, l, (r, i) => {
			let c = a >= i && a <= i + r.nodeSize, l = !r.isLeaf && uu(r);
			return r.type.isTextblock && (c || !t.showOnlyCurrent) && l && o.push(q_({
				editor: e,
				isEmptyDoc: s,
				dataAttribute: n,
				hasAnchor: c,
...
function ev({ view: e, scrollContainer: t }) {
	let n = e.dom.getBoundingClientRect();
	if (n.width <= 0 || n.height <= 0) return null;
	let r = t ? $_(t) : {
		top: 0,
		bottom: window.innerHeight
	}, i = Math.max(n.top, r.top) - K_, a = Math.min(n.bottom, r.bottom) + K_;
	if (i >= a) return null;
...
function nv(e) {
	let t = Q_(e.dom), n = () => {
		...
		if (n === null) return;
		let r = G_.getState(e.state);
		if (r?.topPos === n.top && r?.bottomPos === n.bottom) return;
		let i = e.state.tr.setMeta(G_, { positions: n });
		e.dispatch(i);
	}, r = null, i = 0, a = () => {
...
function rv({ editor: e, options: t }) {
	let n = t.dataAttribute ? `data-${X_(t.dataAttribute)}` : `data-${W_}`;
	return new D({
		key: G_,
		state: tv,
		view: nv,
		props: { decorations: ({ doc: r, selection: i }) => Y_({
			editor: e,
			options: t,
			dataAttribute: n,
			doc: r,
...
var iv = ".ProseMirror:not(.ProseMirror-focused) *::selection {\n  background: transparent;\n}\n\n.ProseMirror:not(.ProseMirror-focused) *::-moz-selection {\n  background: transparent;\n}";
H.create({
	name: "selection",
	addOptions() {
	...
	addProseMirrorPlugins() {
		...
		return e.options.injectCSS && typeof document < "u" && Wu(iv, e.options.injectNonce, "selection"), [new D({
			key: new O("selection"),
			props: { decorations(n) {
				return n.selection.empty || e.isFocused || !e.isEditable || du(n.selection) || e.view.dragging ? null : F.create(n.doc, [rs.inline(n.selection.from, n.selection.to, { class: t.className })]);
			} }
		})];
	}
});
function av({ types: e, node: t }) {
...
var ov = H.create({
	...
	addCommands() {
		return {
			undo: () => ({ state: e, dispatch: t }) => B_(e, t),
			redo: () => ({ state: e, dispatch: t }) => V_(e, t)
		};
	},
	addProseMirrorPlugins() {
		return [R_(this.options)];
	},
	addKeyboardShortcuts() {
		return {
	...
	addExtensions() {
		let e = [];
		return this.options.bold !== !1 && e.push(_p.configure(this.options.bold)), this.options.blockquote !== !1 && e.push(fp.configure(this.options.blockquote)), this.options.bulletList !== !1 && e.push(Zh.configure(this.options.bulletList)), this.options.code !== !1 && e.push(bp.configure(this.options.code)), this.options.codeBlock !== !1 && e.push(wp.configure(this.options.codeBlock)), this.options.document !== !1 && e.push(Tp.configure(this.options.document)), this.options.dropcursor !== !1 && e.push(H_.configure(this.options.dropcursor)), this.options.gapcursor !== !1 && e.push(U_.configure(this.options.gapcursor)), this.options.hardBreak !== !1 && e.push(Ep.configure(this.options.hardBreak)), this.options.heading !== !1 && e.push(Dp.configure(this.options.heading)), this.options.undoRedo !== !1 && e.push(sv.configure(this.options.undoRedo)), this.options.horizontalRule !== !1 && e.push(Op.configure(this.options.horizontalRule)), this.options.italic !== !1 && e.push(Np.configure(this.options.italic)), this.options.listItem !== !1 && e.push(bg.configure(this.options.listItem)), this.options.listKeymap !== !1 && e.push(jg.configure(this.options?.listKeymap)), this.options.link !== !1 && e.push(Gh.configure(this.options?.link)), this.options.orderedList !== !1 && e.push(qg.configure(this.options.orderedList)), this.options.paragraph !== !1 && e.push($g.configure(this.options.paragraph)), this.options.strike !== !1 && e.push(n_.configure(this.options.strike)), this.options.text !== !1 && e.push(r_.configure(this.options.text)), this.options.underline !== !1 && e.push(i_.configure(this.options?.underline)), this.options.trailingNode !== !1 && e.push(ov.configure(this.options?.trailingNode)), e;
	}
}), lv = 20, uv = (e, t = 0) => {
	let n = [];
	return !e.children.length || t > lv || Array.from(e.children).forEach((e) => {
		e.tagName === "SPAN" ? n.push(e) : e.children.length && n.push(...uv(e, t + 1));
	}), n;
}, dv = (e) => {
	...
	parseHTML() {
		return [{
			tag: "span",
			consuming: !1,
			getAttrs: (e) => e.hasAttribute("style") ? (this.options.mergeNestedSpanStyles && dv(e), {}) : !1
		}];
	},
	renderHTML({ HTMLAttributes: e }) {
		return [
	...
	addGlobalAttributes() {
		return [{
			...
			attributes: { backgroundColor: {
				default: null,
				parseHTML: (e) => (Gu(e, "background-color") ?? e.style.backgroundColor)?.replace(/['"]+/g, ""),
	...
	addGlobalAttributes() {
		return [{
			...
			attributes: { color: {
				default: null,
				parseHTML: (e) => (Gu(e, "color") ?? e.style.color)?.replace(/['"]+/g, ""),
	...
	addGlobalAttributes() {
		return [{
			...
			attributes: { fontFamily: {
				default: null,
				parseHTML: (e) => Gu(e, "font-family") ?? e.style.fontFamily,
	...
	addGlobalAttributes() {
		return [{
			...
			attributes: { fontSize: {
				default: null,
				parseHTML: (e) => Gu(e, "font-size") ?? e.style.fontSize,
	...
	addGlobalAttributes() {
		return [{
			...
			attributes: { lineHeight: {
				default: null,
				parseHTML: (e) => Gu(e, "line-height") ?? e.style.lineHeight,
...
H.create({
	...
	addExtensions() {
		let e = [];
		return this.options.backgroundColor !== !1 && e.push(pv.configure(this.options.backgroundColor)), this.options.color !== !1 && e.push(mv.configure(this.options.color)), this.options.fontFamily !== !1 && e.push(hv.configure(this.options.fontFamily)), this.options.fontSize !== !1 && e.push(gv.configure(this.options.fontSize)), this.options.lineHeight !== !1 && e.push(_v.configure(this.options.lineHeight)), this.options.textStyle !== !1 && e.push(fv.configure(this.options.textStyle)), e;
	}
});
//#endregion
//#region node_modules/@tiptap/extension-color/dist/index.js
var vv = mv, yv = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))$/, bv = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))/g, xv = dd.create({
	name: "highlight",
	addOptions() {
		return {
			multicolor: !1,
	...
	addAttributes() {
		return this.options.multicolor ? { color: {
			default: null,
			parseHTML: (e) => e.getAttribute("data-color") || Gu(e, "background-color") || e.style.backgroundColor,
...
window.TIPTAP = {
	...
	Highlight: xv,
	TextAlign: Sv
}, window.TIPTAP_READY = Promise.resolve(window.TIPTAP), window.dispatchEvent(new CustomEvent("tiptap-runtime-ready"));
//#endregion
